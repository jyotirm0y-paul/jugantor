    ...
    <>
      <main class="container-fluid">
        ...
        <div class="container px-0">
          ...
          <div class="row d-none d-sm-none d-md-block d-lg-block d-xl-block">
            <div class="col-12 mb-3" align="center">
              <div id="jg_desktop_top" class="pg-loaded" style={{ margin: "20px 0px 35px", textAlign: "center" }} data-google-query-id="CJjuhbGykvUCFYEPtwAdOdoCsg">
                {/* <!--refreshed unit[/21711891156/jg_desktop_top] at time[1641103348526] --> */}
                <div id="google_ads_iframe_/21711891156/jg_desktop_top_0__container__" style={{ border: "0pt none" }}><iframe id="google_ads_iframe_/21711891156/jg_desktop_top_0" title="3rd party ad content" name="google_ads_iframe_/21711891156/jg_desktop_top_0" width="970" height="90" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" role="region" aria-label="Advertisement" tabindex="0" sandbox="allow-forms allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" allow="attribution-reporting" srcdoc="" style={{ border: "0px", verticalAlign: "bottom" }} data-google-container-id="9" data-load-complete="true"></iframe></div></div>
            </div>
          </div>


          <div class="row d-lg-none d-xl-none mt-2">
            <div class="col-12" align="center">
              <div id="jg_mobile_atf"></div>
            </div>
          </div>

          <div class="d-none d-sm-none d-md-block d-lg-block d-xl-block">
          </div>
          <div class="row d-lg-none d-xl-none mt-2 pl-4">
          </div>
        ...
        <div class="container px-0">
          <div class="row">
            <div class="col-md-8">
              ...
              <div class="row d-none d-sm-none d-md-block d-lg-block d-xl-block">
                <div class="col-12 mb-3" align="center">
                  <div id="jg_desktop_homecateg_header" class="pg-loaded" style={{ margin: "20px 0px 35px", textAlign: "center", display: "none" }} data-google-query-id="CJih8fOxkvUCFQMdtwAdORYPLA">
                    <div id="google_ads_iframe_/21711891156/jg_desktop_homecateg_header_0__container__" style={{ border: "0pt none", width: "728px", height: "0px" }}></div></div>
                </div>
              </div>
              ...
              <div id="lead-news" class="row row-cols-1 mb-3">
                <div id="category" class="col">
                  <div class="row">

                    <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 pt-2 pt-sm-2 pt-md-2 pt-lg-2 pt-xl-2">

                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/todays-paper/first-page/504154/ঘুসের-ড্রাইভিং-সিটে-দালাল-আড়ালে-ভাগ-পান-কর্তা" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" class="card-img rounded-0 w-100 d-block" alt="পাসপোর্ট" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504154-1641098756.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h6 id="news-header" class="card-title mb-1">উত্তরা পাসপোর্ট অফিসে পুরোনো চিত্র</h6>
                            <h3 class="card-title font-weight-bold">ঘুসের ড্রাইভিং সিটে দালাল আড়ালে ভাগ পান কর্তা</h3>
                          </div>
                        </a>
                      </div>

                      <div id="desktop-cat-lead" class="card top_lead_card top_lead_card_type-2 border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/todays-paper/first-page/504154/ঘুসের-ড্রাইভিং-সিটে-দালাল-আড়ালে-ভাগ-পান-কর্তা" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" class="card-img rounded-0 w-100 d-block" alt="পাসপোর্ট" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504154-1641098756.jpg" />
                          <div class="card-body pl-0 py-3">
                            <h6 id="news-header" class="text-decoration-none text-danger">উত্তরা পাসপোর্ট অফিসে পুরোনো চিত্র</h6>
                            <h2 class="card-title font-weight-bold" style={{ fontSize: "28px !important" }}>ঘুসের ড্রাইভিং সিটে দালাল আড়ালে ভাগ পান কর্তা</h2>
                          </div>
                        </a>
                      </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 d-none d-sm-none d-md-block d-lg-block d-xl-block pt-2 pt-sm-2 pt-md-2 pt-lg-2 pt-xl-2">
                      <div class="row">
                        <div class="col-12">
                          <a href="https://www.jugantor.com/national/504358/নিষেধাজ্ঞা-প্রত্যাহারে-যুক্তরাষ্ট্রকে-বাংলাদেশের-চিঠি">
                            <figure class="figure">
                              <img loading="lazy" alt="র‌্যাব" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504358-1641101910.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">নিষেধাজ্ঞা প্রত্যাহারে যুক্তরাষ্ট্রকে বাংলাদেশের চিঠি</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-12">
                          <a href="https://www.jugantor.com/covid-19/504357/করোনার-তৃতীয়-ঢেউয়েও-লকডাউন-দেবে-না-ভারত">
                            <figure class="figure">
                              <img loading="lazy" alt="করোনার তৃতীয় ঢেউয়েও লকডাউন দেবে না ভারত!" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504357-1641101254.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">করোনার তৃতীয় ঢেউয়েও লকডাউন দেবে না ভারত!</figcaption>
                            </figure>
                          </a>
                        </div>
                      </div>
              ...
              <div class="row d-none d-sm-none d-md-block d-lg-block d-xl-block">
                <div class="col-12 mb-3" align="center">
                  <div id="jg_desktop_homecateg_midview" class="pg-loaded" style={{ margin: "20px 0px 35px", textAlign: "center" }} data-google-query-id="CNSS7fCvkvUCFS4CtwAdzCMLGQ"><div id="google_ads_iframe_/21711891156/jg_desktop_homecateg_midview_0__container__" style={{ border: "0pt none" }}><iframe id="google_ads_iframe_/21711891156/jg_desktop_homecateg_midview_0" title="3rd party ad content" name="google_ads_iframe_/21711891156/jg_desktop_homecateg_midview_0" width="728" height="90" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" role="region" aria-label="Advertisement" tabindex="0" allow="attribution-reporting" srcdoc="" data-google-container-id="5" style={{ border: "0px, verticalAlign: bottom" }} data-load-complete="true"></iframe></div></div>
                </div>
              </div>
              ...
              <div class="row d-lg-none d-xl-none mt-2">
                <div class="col-12" align="center">
                  <div id="jg_mobile_homecateg_top"></div>
                  <div class="spacebar"></div>
                </div>
                <div class="col-12" align="center">
                  <div class="row row-cols-2 row-cols-sm-2 row-cols-md-3" align="center">
                    <div class="col">
                      <a href="https://www.jugantor.com/economics/share-market" target="_blank" class="text-decoration-none">
                        <img src="https://jamuna.jugantor.com/assets/uploads/extra_link_logo/share_bazar.jpeg" class="img-fluid" alt="শেয়ার বাজার" />
                      </a>
                    </div>
                    <div class="col">
                      <a href="https://www.jugantor.com/campus/tutorials" target="_blank" class="text-decoration-none">
                        <img src="https://jamuna.jugantor.com/assets/uploads/extra_link_logo/tutorial.jpeg" class="img-fluid" alt="টিউটোরিয়াল" />
                      </a>
                    </div>
                  </div>
                  <div class="spacebar"></div>
                  <div class="row row-cols-2 row-cols-sm-2 row-cols-md-3" align="center">
                    <div class="col">
                      <a href="https://www.jugantor.com/various" target="_blank" class="text-decoration-none">
                        <img src="https://jamuna.jugantor.com/assets/uploads/extra_link_logo/chitro_bichitro.jpeg" class="img-fluid" alt="চিত্র বিচিত্র" />
                      </a>
                    </div>
                    <div class="col">
                      <a href="https://www.jugantor.com/islam-life" target="_blank" class="text-decoration-none">
                        <img src="https://jamuna.jugantor.com/assets/uploads/extra_link_logo/Islam o Jibon.png" class="img-fluid" alt="ইসলাম ও জীবন" />
                      </a>
                    </div>
                  </div>
                  <div class="spacebar"></div>
        ...
        <div class="col-md-4 d-none d-sm-none d-md-none d-lg-block d-xl-block">
          <a href="https://www.jugantor.com/todays-paper/it-world/504174/ডিজেবল-হয়ে-যাচ্ছে-ফেসবুক-অ্যাকাউন্ট-যা-করণীয়" class="text-decoration-none">
            <figure class="figure">
              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504174-1641101022.jpg" class="figure-img h-100 w-100" alt="ডিজেবল হয়ে যাচ্ছে ফেসবুক অ্যাকাউন্ট যা করণীয়" />
              <h6 id="news-header" class="text-decoration-none text-danger">টিপস</h6>
              <figcaption class="figure-caption">ডিজেবল হয়ে যাচ্ছে ফেসবুক অ্যাকাউন্ট যা করণীয়</figcaption>
            </figure>
          </a>
        </div>
        <div class="col-md-4 d-none d-sm-none d-md-none d-lg-block d-xl-block">
          <a href="https://www.jugantor.com/entertainment/504355/জ্যাকুলিনের-সঙ্গে-আমার-সম্পর্ক-ছিল-সুকেশ" class="text-decoration-none">
            <figure class="figure">
              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504355-1641100151.jpg" class="figure-img h-100 w-100" alt="জ্যাকুলিনের সঙ্গে আমার সম্পর্ক ছিল: সুকেশ" />
              <figcaption class="figure-caption">জ্যাকুলিনের সঙ্গে আমার সম্পর্ক ছিল: সুকেশ</figcaption>
            </figure>
          </a>
        </div>
        <div class="col-md-4 d-none d-sm-none d-md-none d-lg-block d-xl-block">
          <a href="https://www.jugantor.com/international/504354/কাশ্মীরের-সাবেক-৩-মুখ্যমন্ত্রী-গৃহবন্দি&nbsp;" class="text-decoration-none">
            <figure class="figure">
              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504354-1641099581.jpg" class="figure-img h-100 w-100" alt="কাশ্মীরের সাবেক ৩ মুখ্যমন্ত্রী গৃহবন্দি&nbsp;" />
              <figcaption class="figure-caption">কাশ্মীরের সাবেক ৩ মুখ্যমন্ত্রী গৃহবন্দি&nbsp;</figcaption>
            </figure>
          </a>
        </div>
        <div class="col-md-4 d-none d-sm-none d-md-none d-lg-block d-xl-block">
          <a href="https://www.jugantor.com/sports/504353/সৌম্যের-সেই-রেকর্ডে-ভাগ-বসালেন-সাদমান" class="text-decoration-none">
            <figure class="figure">
              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504353-1641099419.jpg" class="figure-img h-100 w-100" alt="সৌম্যের সেই রেকর্ডে ভাগ বসালেন সাদমান" />
              <figcaption class="figure-caption">সৌম্যের সেই রেকর্ডে ভাগ বসালেন সাদমান</figcaption>
            </figure>
          </a>
        </div>
        <div class="col-md-4 d-none d-sm-none d-md-none d-lg-block d-xl-block">
          <a href="https://www.jugantor.com/todays-paper/first-page/504151/শূন্য-থাকবে-পাঁচ-লাখ-আসন" class="text-decoration-none">
            <figure class="figure">
              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504151-1641071614.jpg" class="figure-img h-100 w-100" alt="উচ্চ মাধ্যমিক" />
              <h6 id="news-header" class="text-decoration-none text-danger">উচ্চ মাধ্যমিক স্তরে ভর্তি</h6>
              <figcaption class="figure-caption">শূন্য থাকবে পাঁচ লাখ আসন</figcaption>
            </figure>
          </a>
        </div>
        <div class="col-md-4 d-none d-sm-none d-md-none d-lg-block d-xl-block">
          <a href="https://www.jugantor.com/country-news/504349/ছাগল-খেতে-এসে-ঢাকায়-ধরা-পড়ল-সুন্দরবনের-বাঘ-ভিডিও" class="text-decoration-none">
            <figure class="figure">
              <span class="rounded-circle border border-white vid-icon-lead-show overflow-hidden text-center pt-3 pl-2">
                <i class="fas fa-play fa-2x text-white"></i>
              </span>
              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504349-1641098187.jpg" class="figure-img h-100 w-100" alt="বাঘ" />
              <figcaption class="figure-caption">ছাগল খেতে এসে ঢাকায় ধরা পড়ল সুন্দরবনের বাঘ (ভিডিও)</figcaption>
            </figure>
          </a>
        </div>
        <div class="col-md-4 d-none d-sm-none d-md-none d-lg-block d-xl-block">
          <a href="https://www.jugantor.com/sports/504347/দুই-অর্ধশতকে-ভর-করে-দারুণ-লড়াইয়ে-বাংলাদেশ" class="text-decoration-none">
            <figure class="figure">
              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504347-1641097786.jpg" class="figure-img h-100 w-100" alt="দুই অর্ধশতকে ভর করে দারুণ লড়াইয়ে বাংলাদেশ" />
              <figcaption class="figure-caption">দুই অর্ধশতকে ভর করে দারুণ লড়াইয়ে বাংলাদেশ</figcaption>
            </figure>
          </a>
        </div>
        <div class="col-md-4 d-none d-sm-none d-md-none d-lg-block d-xl-block">
          <a href="https://www.jugantor.com/country-news/504346/সুনামগঞ্জে-ট্রাকচাপায়-অটোরিকশার-২-যাত্রী-নিহত" class="text-decoration-none">
            <figure class="figure">
              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504346-1641097469.jpg" class="figure-img h-100 w-100" alt="সড়ক ‍দুর্ঘটনা" />
              <figcaption class="figure-caption">সুনামগঞ্জে ট্রাকচাপায় অটোরিকশার ২ যাত্রী নিহত</figcaption>
            </figure>
          </a>
        </div>
        <div class="col-md-4 d-none d-sm-none d-md-none d-lg-block d-xl-block">
          <a href="https://www.jugantor.com/todays-paper/anando-nagar/504233/এ-দেশ-ছেড়ে-কোথাও-যাচ্ছি-না" class="text-decoration-none">
            <figure class="figure">
              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504233-1641097125.jpg" class="figure-img h-100 w-100" alt="এ দেশ ছেড়ে কোথাও যাচ্ছি না" />
              <h6 id="news-header" class="text-decoration-none text-danger">হ্যালো...</h6>
              <figcaption class="figure-caption">এ দেশ ছেড়ে কোথাও যাচ্ছি না</figcaption>
            </figure>
          </a>
        </div>
      </div>

              <div id="show-news" class="row row-cols-2 row-cols-sm-2 row-cols-md-3 d-lg-none d-xl-none">
                <div class="col">
                  <a href="https://www.jugantor.com/national/504358/নিষেধাজ্ঞা-প্রত্যাহারে-যুক্তরাষ্ট্রকে-বাংলাদেশের-চিঠি" class="text-decoration-none">
                    <figure class="figure">
                      <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504358-1641101910.jpg" class="figure-img h-100 w-100" alt="র‌্যাব" />
                      <figcaption class="figure-caption">নিষেধাজ্ঞা প্রত্যাহারে যুক্তরাষ্ট্রকে বাংলাদেশের চিঠি</figcaption>
                    </figure>
                  </a>
                </div>
                <div class="col">
                  <a href="https://www.jugantor.com/covid-19/504357/করোনার-তৃতীয়-ঢেউয়েও-লকডাউন-দেবে-না-ভারত" class="text-decoration-none">
                    <figure class="figure">
                      <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504357-1641101254.jpg" class="figure-img h-100 w-100" alt="করোনার তৃতীয় ঢেউয়েও লকডাউন দেবে না ভারত!" />
                      <figcaption class="figure-caption">করোনার তৃতীয় ঢেউয়েও লকডাউন দেবে না ভারত!</figcaption>
                    </figure>
                  </a>
                </div>
                ...
                <div class="col">
                  <a href="https://www.jugantor.com/country-news/504349/ছাগল-খেতে-এসে-ঢাকায়-ধরা-পড়ল-সুন্দরবনের-বাঘ-ভিডিও" class="text-decoration-none">
                    <figure class="figure">
                      <span class="rounded-circle border border-white vid-icon-show-xs overflow-hidden text-center pt-2 pl-1">
                        <i class="fas fa-play fa-1x text-white"></i>
                      </span>
                      <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504349-1641098187.jpg" class="figure-img h-100 w-100" alt="বাঘ" />
                      <figcaption class="figure-caption">ছাগল খেতে এসে ঢাকায় ধরা পড়ল সুন্দরবনের বাঘ (ভিডিও)</figcaption>
                    </figure>
              ...
              <div class="row d-none d-sm-none d-md-block d-lg-block d-xl-block">
                <div class="col-12 mb-3" align="center">
                  <div id="jg_desktop_homecateg_mid1" class="pg-loaded" style={{ margin: "20px 0px 35px", textAlign: "center" }} data-google-query-id="CLvl7fCvkvUCFXcOtwAdRIIKVw"><div id="google_ads_iframe_/21711891156/jg_desktop_homecateg_mid1_0__container__" style={{ border: "0pt none" }}><iframe id="google_ads_iframe_/21711891156/jg_desktop_homecateg_mid1_0" title="3rd party ad content" name="google_ads_iframe_/21711891156/jg_desktop_homecateg_mid1_0" width="728" height="90" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" role="region" aria-label="Advertisement" tabindex="0" allow="attribution-reporting" srcdoc="" data-google-container-id="8" style={{ border: "0px, verticalAlign: bottom" }} data-load-complete="true"></iframe></div></div>
                </div>
              </div>
              ...
              <div class="row d-lg-none d-xl-none mt-2">
                <div class="col-12" align="center">
                  <div id="Jugantor_Direct_Daraz"></div>
                  <div class="spacebar"></div>
                </div>
              </div>
              ...
              <div class="row row-cols-1 d-md-none d-lg-none d-xl-none">
                <div id="most-recent-news-tab" class="col bg-white mb-2 mb-sm-0 mb-md-0 mb-lg-0 mb-xl-0">
                  <ul id="myTab" role="tablist" class="nav nav-tabs nav-pills text-center border-0">
                    <li class="nav-item flex-fill flex-sm-fill pr-2">
                      <a id="home-tab" data-toggle="tab" href="#recent-view" role="tab" aria-controls="recent-view" aria-selected="true" class="nav-link border-0 text-uppercase font-weight-bold py-1 active">সর্বশেষ</a>
                    </li>
                    <li class="nav-item flex-fill flex-sm-fill pl-2">
                      <a id="profile-tab" data-toggle="tab" href="#most-view" role="tab" aria-controls="most-view" aria-selected="false" class="nav-link border-0 text-uppercase font-weight-bold py-1">সর্বাধিক
                        পঠিত</a>
                    </li>
                  </ul>
                  <div id="news-list" class="tab-content">
                    <div id="recent-view" role="tabpanel" aria-labelledby="home-tab" class="tab-pane fade px-0 my-2 show active">
                      <div class="slimScrollDiv" style={{ position: "relative", overflow: "hidden", width: "auto", height: "410px" }}><div id="most-recent-news" style={{ overflow: "hidden", width: "auto", height: "410px" }}>
                        <div class="row row-cols-1 no-gutters mb-2">
                          <div class="col-3">
                            <a href="https://www.jugantor.com/national/504358/নিষেধাজ্ঞা-প্রত্যাহারে-যুক্তরাষ্ট্রকে-বাংলাদেশের-চিঠি" class="text-decoration-none">
                              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504358-1641101910.jpg" class="img-fluid" width="90" height="60" alt="র‌্যাব" />
                            </a>
                          </div>
                          <div class="col-9 align-self-center px-3">
                            <a href="https://www.jugantor.com/national/504358/নিষেধাজ্ঞা-প্রত্যাহারে-যুক্তরাষ্ট্রকে-বাংলাদেশের-চিঠি" class="text-decoration-none">
                              <h6 class="tab-news-title">নিষেধাজ্ঞা প্রত্যাহারে যুক্তরাষ্ট্রকে বাংলাদেশের চিঠি</h6>
                            </a>
                          </div>
                        </div>
                        <div class="row row-cols-1 no-gutters mb-2">
                          <div class="col-3">
                            <a href="https://www.jugantor.com/covid-19/504357/করোনার-তৃতীয়-ঢেউয়েও-লকডাউন-দেবে-না-ভারত" class="text-decoration-none">
                              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504357-1641101254.jpg" class="img-fluid" width="90" height="60" alt="করোনার তৃতীয় ঢেউয়েও লকডাউন দেবে না ভারত!" />
                            </a>
                          </div>
                          <div class="col-9 align-self-center px-3">
                            <a href="https://www.jugantor.com/covid-19/504357/করোনার-তৃতীয়-ঢেউয়েও-লকডাউন-দেবে-না-ভারত" class="text-decoration-none">
                              <h6 class="tab-news-title">করোনার তৃতীয় ঢেউয়েও লকডাউন দেবে না ভারত!</h6>
                            </a>
                          </div>
                        </div>
                        <div class="row row-cols-1 no-gutters mb-2">
                          <div class="col-3">
                            <a href="https://www.jugantor.com/country-news/504356/টেকনাফে-অস্ত্রসহ-যুবক-আটক" class="text-decoration-none">
                              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504356-1641101027.jpg" class="img-fluid" width="90" height="60" alt="আটক" />
                            </a>
                          </div>
                          <div class="col-9 align-self-center px-3">
                            <a href="https://www.jugantor.com/country-news/504356/টেকনাফে-অস্ত্রসহ-যুবক-আটক" class="text-decoration-none">
                              <h6 class="tab-news-title">টেকনাফে অস্ত্রসহ যুবক আটক</h6>
                            </a>
                          </div>
                        </div>
                        <div class="row row-cols-1 no-gutters mb-2">
                          <div class="col-3">
                            <a href="https://www.jugantor.com/entertainment/504355/জ্যাকুলিনের-সঙ্গে-আমার-সম্পর্ক-ছিল-সুকেশ" class="text-decoration-none">
                              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504355-1641100151.jpg" class="img-fluid" width="90" height="60" alt="জ্যাকুলিনের সঙ্গে আমার সম্পর্ক ছিল: সুকেশ" />
                            </a>
                          </div>
                          <div class="col-9 align-self-center px-3">
                            <a href="https://www.jugantor.com/entertainment/504355/জ্যাকুলিনের-সঙ্গে-আমার-সম্পর্ক-ছিল-সুকেশ" class="text-decoration-none">
                              <h6 class="tab-news-title">জ্যাকুলিনের সঙ্গে আমার সম্পর্ক ছিল: সুকেশ</h6>
                            </a>
                          </div>
                        </div>
                        <div class="row row-cols-1 no-gutters mb-2">
                          <div class="col-3">
                            <a href="https://www.jugantor.com/international/504354/কাশ্মীরের-সাবেক-৩-মুখ্যমন্ত্রী-গৃহবন্দি&nbsp;" class="text-decoration-none">
                              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504354-1641099581.jpg" class="img-fluid" width="90" height="60" alt="কাশ্মীরের সাবেক ৩ মুখ্যমন্ত্রী গৃহবন্দি&nbsp;" />
                            </a>
                          </div>
                          <div class="col-9 align-self-center px-3">
                            <a href="https://www.jugantor.com/international/504354/কাশ্মীরের-সাবেক-৩-মুখ্যমন্ত্রী-গৃহবন্দি&nbsp;" class="text-decoration-none">
                              <h6 class="tab-news-title">কাশ্মীরের সাবেক ৩ মুখ্যমন্ত্রী গৃহবন্দি&nbsp;</h6>
                            </a>
                          </div>
                        </div>
                        <div class="row row-cols-1 no-gutters mb-2">
                          <div class="col-3">
                            <a href="https://www.jugantor.com/sports/504353/সৌম্যের-সেই-রেকর্ডে-ভাগ-বসালেন-সাদমান" class="text-decoration-none">
                              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504353-1641099419.jpg" class="img-fluid" width="90" height="60" alt="সৌম্যের সেই রেকর্ডে ভাগ বসালেন সাদমান" />
                            </a>
                          </div>
                          <div class="col-9 align-self-center px-3">
                            <a href="https://www.jugantor.com/sports/504353/সৌম্যের-সেই-রেকর্ডে-ভাগ-বসালেন-সাদমান" class="text-decoration-none">
                              <h6 class="tab-news-title">সৌম্যের সেই রেকর্ডে ভাগ বসালেন সাদমান</h6>
                            </a>
                          </div>
                        </div>
                        <div class="row row-cols-1 no-gutters mb-2">
                          <div class="col-3">
                            <a href="https://www.jugantor.com/country-news/504352/নানাবাড়িতে-একাধিকবার-ধর্ষণে-অন্তঃসত্ত্বা-কিশোরী-অতঃপর..." class="text-decoration-none">
                              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504352-1641099046.jpg" class="img-fluid" width="90" height="60" alt="ধর্ষণ" />
                            </a>
                          </div>
                          <div class="col-9 align-self-center px-3">
                            <a href="https://www.jugantor.com/country-news/504352/নানাবাড়িতে-একাধিকবার-ধর্ষণে-অন্তঃসত্ত্বা-কিশোরী-অতঃপর..." class="text-decoration-none">
                              <h6 class="tab-news-title">নানাবাড়িতে একাধিকবার ধর্ষণে অন্তঃসত্ত্বা কিশোরী, অতঃপর...</h6>
                            </a>
                          </div>
                        </div>
                        <div class="row row-cols-1 no-gutters mb-2">
                          <div class="col-3">
                            <a href="https://www.jugantor.com/capital/504351/ঢাকায়-ইয়াবাগাঁজাসহ-গ্রেফতার-৩১" class="text-decoration-none">
                              <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504351-1641098878.jpg" class="img-fluid" width="90" height="60" alt="প্রতীকী ছবি" />
                            </a>
                          </div>
                          <div class="col-9 align-self-center px-3">
                            <a href="https://www.jugantor.com/capital/504351/ঢাকায়-ইয়াবাগাঁজাসহ-গ্রেফতার-৩১" class="text-decoration-none">
                              <h6 class="tab-news-title">ঢাকায় ইয়াবা-গাঁজাসহ গ্রেফতার ৩১</h6>
                            </a>
                          </div>
                        </div>
                      </div>
                        <div class="slimScrollBar" style={{ background: "rgb(0, 0, 0)", width: "7px", position: "absolute", top: "0px", opacity: "0.4", display: "block", borderRadius: "7px", zIndex: "99", right: "1px" }}></div><div class="slimScrollRail" style={{ width: "7px", height: "100%", position: "absolute", top: "0px", display: "none", borderRadius: "7px", background: "rgb(51, 51, 51", opacity: "0.2", zIndex: "90", right: "1px" }}></div></div>
                      <div class="nav nav-pills nav-fill mt-2">
                        <span class="nav-item"><a class="nav-link active py-1 font-weight-bold" href="https://www.jugantor.com/all-news">সব খবর</a></span>
                      </div>
                    </div>
                    <div id="most-view" role="tabpanel" aria-labelledby="profile-tab" class="tab-pane fade px-0 my-2">
                      <div class="slimScrollDiv" style={{ position: "relative", overflow: "hidden", width: "auto", height: "410px" }}>
                        <div id="most-viewed-news" style={{ overflow: "hidden", width: "auto", height: "410px" }}>
                          <div class="row row-cols-1 no-gutters mb-2">
                            <div class="col-3">
                              <a href="https://www.jugantor.com/international/504088/পাকিস্তান-পররাষ্ট্রমন্ত্রীর-বসার-ভঙ্গি-নিয়ে-ক্ষুব্ধ-সৌদিরা" class="text-decoration-none">
                                <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504088-1641038868.jpg" class="img-fluid" width="90" height="60" alt="পাকিস্তান পররাষ্ট্রমন্ত্রীর বসার ভঙ্গি নিয়ে ক্ষুব্ধ সৌদিরা" />
                              </a>
                            </div>
                            <div class="col-9 align-self-center px-3">
                              <a href="https://www.jugantor.com/international/504088/পাকিস্তান-পররাষ্ট্রমন্ত্রীর-বসার-ভঙ্গি-নিয়ে-ক্ষুব্ধ-সৌদিরা" class="text-decoration-none">
                                <h6 class="tab-news-title">পাকিস্তান পররাষ্ট্রমন্ত্রীর বসার ভঙ্গি নিয়ে ক্ষুব্ধ সৌদিরা</h6>
                              </a>
                            </div>
                          </div>
                          <div class="row row-cols-1 no-gutters mb-2">
                            <div class="col-3">
                              <a href="https://www.jugantor.com/international/504026/বাবার-ফাঁসির-১৫-বছরে-যা-বললেন-সাদ্দাম-কন্যা" class="text-decoration-none">
                                <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504026-1641005511.jpg" class="img-fluid" width="90" height="60" alt="বাবার ফাঁসির ১৫ বছরে যা বললেন সাদ্দাম কন্যা" />
                              </a>
                            </div>
                            <div class="col-9 align-self-center px-3">
                              <a href="https://www.jugantor.com/international/504026/বাবার-ফাঁসির-১৫-বছরে-যা-বললেন-সাদ্দাম-কন্যা" class="text-decoration-none">
                                <h6 class="tab-news-title">বাবার ফাঁসির ১৫ বছরে যা বললেন সাদ্দাম কন্যা</h6>
                              </a>
                            </div>
                          </div>
                          <div class="row row-cols-1 no-gutters mb-2">
                            <div class="col-3">
                              <a href="https://www.jugantor.com/politics/504068/সংলাপে-না-যেতে-ড.-কামালকে-অনুরোধ-করেছি" class="text-decoration-none">
                                <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504068-1641029638.jpg" class="img-fluid" width="90" height="60" alt="‘সংলাপে না যেতে ড. কামালকে অনুরোধ করেছি’" />
                              </a>
                            </div>
                            <div class="col-9 align-self-center px-3">
                              <a href="https://www.jugantor.com/politics/504068/সংলাপে-না-যেতে-ড.-কামালকে-অনুরোধ-করেছি" class="text-decoration-none">
                                <h6 class="tab-news-title">‘সংলাপে না যেতে ড. কামালকে অনুরোধ করেছি’</h6>
                              </a>
                            </div>
                          </div>
                          <div class="row row-cols-1 no-gutters mb-2">
                            <div class="col-3">
                              <a href="https://www.jugantor.com/national/others/504103/ইসি-গঠন-নিয়ে-বিস্ফোরক-মন্তব্য-আকবর-আলি-খানের" class="text-decoration-none">
                                <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504103-1641043770.jpg" class="img-fluid" width="90" height="60" alt="ইসি গঠন নিয়ে বিস্ফোরক মন্তব্য আকবর আলি খানের" />
                              </a>
                            </div>
                            <div class="col-9 align-self-center px-3">
                              <a href="https://www.jugantor.com/national/others/504103/ইসি-গঠন-নিয়ে-বিস্ফোরক-মন্তব্য-আকবর-আলি-খানের" class="text-decoration-none">
                                <h6 class="tab-news-title">ইসি গঠন নিয়ে বিস্ফোরক মন্তব্য আকবর আলি খানের</h6>
                              </a>
                            </div>
                          </div>
                          <div class="row row-cols-1 no-gutters mb-2">
                            <div class="col-3">
                              <a href="https://www.jugantor.com/sports/504034/আর্জেন্টিনার-মার্টিনেজ-লিখলেন-লাভ-ফ্রম-বাংলাদেশ" class="text-decoration-none">
                                <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504034-1641010764.jpg" class="img-fluid" width="90" height="60" alt="আর্জেন্টিনার মার্টিনেজ লিখলেন, ‘লাভ ফ্রম বাংলাদেশ’" />
                              </a>
                            </div>
                            <div class="col-9 align-self-center px-3">
                              <a href="https://www.jugantor.com/sports/504034/আর্জেন্টিনার-মার্টিনেজ-লিখলেন-লাভ-ফ্রম-বাংলাদেশ" class="text-decoration-none">
                                <h6 class="tab-news-title">আর্জেন্টিনার মার্টিনেজ লিখলেন, ‘লাভ ফ্রম বাংলাদেশ’</h6>
                              </a>
                            </div>
                          </div>
                          <div class="row row-cols-1 no-gutters mb-2">
                            <div class="col-3">
                              <a href="https://www.jugantor.com/sports/504060/পাকিস্তান-দলে-একসঙ্গে-খেলবেন-চাচাভাতিজা" class="text-decoration-none">
                                <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504060-1641026493.jpg" class="img-fluid" width="90" height="60" alt="পাকিস্তান দলে একসঙ্গে খেলবেন চাচা-ভাতিজা!" />
                              </a>
                            </div>
                            <div class="col-9 align-self-center px-3">
                              <a href="https://www.jugantor.com/sports/504060/পাকিস্তান-দলে-একসঙ্গে-খেলবেন-চাচাভাতিজা" class="text-decoration-none">
                                <h6 class="tab-news-title">পাকিস্তান দলে একসঙ্গে খেলবেন চাচা-ভাতিজা!</h6>
                              </a>
                            </div>
                          </div>
                          <div class="row row-cols-1 no-gutters mb-2">
                            <div class="col-3">
                              <a href="https://www.jugantor.com/country-news/504003/রাজনীতি-নিয়ে-যা-বললেন-শামীম-ওসমান" class="text-decoration-none">
                                <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504003-1640996901.jpg" class="img-fluid" width="90" height="60" alt="রাজনীতি নিয়ে যা বললেন শামীম ওসমান" />
                              </a>
                            </div>
                            <div class="col-9 align-self-center px-3">
                              <a href="https://www.jugantor.com/country-news/504003/রাজনীতি-নিয়ে-যা-বললেন-শামীম-ওসমান" class="text-decoration-none">
                                <h6 class="tab-news-title">রাজনীতি নিয়ে যা বললেন শামীম ওসমান</h6>
                              </a>
                            </div>
                          </div>
                          <div class="row row-cols-1 no-gutters mb-2">
                            <div class="col-3">
                              <a href="https://www.jugantor.com/national/504096/আবারো-লকডাউন-নিয়ে-যা-বললেন-স্বাস্থ্যমন্ত্রী" class="text-decoration-none">
                                <img loading="lazy" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504096-1641040255.jpg" class="img-fluid" width="90" height="60" alt="আবারো লকডাউন নিয়ে যা বললেন স্বাস্থ্যমন্ত্রী" />
                              </a>
                            </div>
                            <div class="col-9 align-self-center px-3">
                              <a href="https://www.jugantor.com/national/504096/আবারো-লকডাউন-নিয়ে-যা-বললেন-স্বাস্থ্যমন্ত্রী" class="text-decoration-none">
                                <h6 class="tab-news-title">আবারো লকডাউন নিয়ে যা বললেন স্বাস্থ্যমন্ত্রী</h6>
                              </a>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="nav nav-pills nav-fill">
                        <span class="nav-item"><a class="nav-link active py-1 font-weight-bold" href="https://www.jugantor.com/all-news/all-most-viewed-news">সব খবর</a></span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12" align="center">
                  <div id="jg_mobile_homecateg_mid1"></div>
                  <div class="spacebar"></div>
                </div>
              ...
              <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2">
                <div id="category" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/national">
                      <div class="float-left">জাতীয়</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row mt-2">
                    <div class="col-md-12">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/national/504358/নিষেধাজ্ঞা-প্রত্যাহারে-যুক্তরাষ্ট্রকে-বাংলাদেশের-চিঠি" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" alt="র‌্যাব" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504358-1641101910.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">নিষেধাজ্ঞা প্রত্যাহারে যুক্তরাষ্ট্রকে বাংলাদেশের চিঠি</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card  border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/national/504358/নিষেধাজ্ঞা-প্রত্যাহারে-যুক্তরাষ্ট্রকে-বাংলাদেশের-চিঠি" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" alt="র‌্যাব" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504358-1641101910.jpg" />
                  ...
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/national/504337/বইছে-শৈত্যপ্রবাহ-তাপমাত্রা-আরও-কমতে-পারে" class="text-decoration-none">
                          <img loading="lazy" alt="শৈত্যপ্রবাহ" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504337-1641091291.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/national/504337/বইছে-শৈত্যপ্রবাহ-তাপমাত্রা-আরও-কমতে-পারে" class="text-decoration-none">
                          <h6 class="tab-news-title">বইছে শৈত্যপ্রবাহ, তাপমাত্রা আরও কমতে পারে</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/second-edition/504303/ষষ্ঠ-ধাপের-ইউপি-নির্বাচনে-আওয়ামী-লীগের-প্রার্থী-যারা" class="text-decoration-none">
                          <img loading="lazy" alt="ষষ্ঠ ধাপের ইউপি নির্বাচনে আওয়ামী লীগের প্রার্থী যারা" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504303-1641085617.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/second-edition/504303/ষষ্ঠ-ধাপের-ইউপি-নির্বাচনে-আওয়ামী-লীগের-প্রার্থী-যারা" class="text-decoration-none">
                          <h6 class="tab-news-title">ষষ্ঠ ধাপের ইউপি নির্বাচনে আওয়ামী লীগের প্রার্থী যারা</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/news/504200/করোনা-বাড়লে-আবারও-লকডাউন--স্বাস্থ্যমন্ত্রী" class="text-decoration-none">
                          <img loading="lazy" alt="জাহিদ মালেক" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504200-1641093413.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/news/504200/করোনা-বাড়লে-আবারও-লকডাউন--স্বাস্থ্যমন্ত্রী" class="text-decoration-none">
                          <h6 class="tab-news-title">করোনা বাড়লে আবারও লকডাউন : স্বাস্থ্যমন্ত্রী</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/city/504180/মৃত-বঙ্গবন্ধু-জীবিত-বঙ্গবন্ধুর-চেয়ে-শক্তিশালী-প্রধান-বিচারপতি" class="text-decoration-none">
                          <img loading="lazy" alt="প্রধান বিচারপতি হাসান ফয়েজ সিদ্দিকী" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504180-1641101830.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/city/504180/মৃত-বঙ্গবন্ধু-জীবিত-বঙ্গবন্ধুর-চেয়ে-শক্তিশালী-প্রধান-বিচারপতি" class="text-decoration-none">
                          <h6 class="tab-news-title">মৃত বঙ্গবন্ধু জীবিত বঙ্গবন্ধুর চেয়ে শক্তিশালী: প্রধান বিচারপতি</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div id="category" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/politics">
                      <div class="float-left">রাজনীতি</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row mt-2">
                    <div class="col-md-12">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/politics/504340/সপ্তম-ধাপের-ইউপি-নির্বাচন-আ.লীগের-মনোনয়ন-ফরম-সংগ্রহ-শুরু-আজ" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" alt="আওয়ামী লীগ" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504340-1641094732.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">সপ্তম ধাপের ইউপি নির্বাচন: আ.লীগের মনোনয়ন ফরম সংগ্রহ শুরু আজ</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card  border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/politics/504340/সপ্তম-ধাপের-ইউপি-নির্বাচন-আ.লীগের-মনোনয়ন-ফরম-সংগ্রহ-শুরু-আজ" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" alt="আওয়ামী লীগ" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504340-1641094732.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">সপ্তম ধাপের ইউপি নির্বাচন: আ.লীগের মনোনয়ন ফরম সংগ্রহ শুরু আজ</h3>
                          </div>
                  ...
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/politics/504195/ষষ্ঠ-ধাপের-ইউপি-নির্বাচনে-আ.লীগের-প্রার্থী-যারা" class="text-decoration-none">
                          <img loading="lazy" alt="আ.লীগ" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504195-1641066162.jpeg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/politics/504195/ষষ্ঠ-ধাপের-ইউপি-নির্বাচনে-আ.লীগের-প্রার্থী-যারা" class="text-decoration-none">
                          <h6 class="tab-news-title">ষষ্ঠ ধাপের ইউপি নির্বাচনে আ.লীগের প্রার্থী যারা</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/politics/national-party/504118/জাতীয়-পার্টি-আজ-নতুন-করে-জেগে-উঠেছে-সালমা-ইসলাম-এমপি" class="text-decoration-none">
                          <img loading="lazy" alt="জাতীয় পার্টি আজ নতুন করে জেগে উঠেছে: সালমা ইসলাম এমপি" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504118-1641050850.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/politics/national-party/504118/জাতীয়-পার্টি-আজ-নতুন-করে-জেগে-উঠেছে-সালমা-ইসলাম-এমপি" class="text-decoration-none">
                          <h6 class="tab-news-title">জাতীয় পার্টি আজ নতুন করে জেগে উঠেছে: সালমা ইসলাম এমপি</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/politics/national-party/504113/এখন-নির্বাচন-হচ্ছে-ভয়-আর-আতঙ্কের-নাম" class="text-decoration-none">
                          <img loading="lazy" alt="‘এখন নির্বাচন হচ্ছে ভয় আর আতঙ্কের নাম’" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504113-1641049286.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/politics/national-party/504113/এখন-নির্বাচন-হচ্ছে-ভয়-আর-আতঙ্কের-নাম" class="text-decoration-none">
                          <h6 class="tab-news-title">‘এখন নির্বাচন হচ্ছে ভয় আর আতঙ্কের নাম’</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/politics/bnp/504098/এই-নববর্ষে-খালেদা-জিয়া-মুক্তি-পাবেন" class="text-decoration-none">
                          <img loading="lazy" alt="‘এই নববর্ষে খালেদা জিয়া মুক্তি পাবেন’" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504098-1641042943.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/politics/bnp/504098/এই-নববর্ষে-খালেদা-জিয়া-মুক্তি-পাবেন" class="text-decoration-none">
                          <h6 class="tab-news-title">‘এই নববর্ষে খালেদা জিয়া মুক্তি পাবেন’</h6>
                        </a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row d-none d-sm-none d-md-block d-lg-block d-xl-block">
                <div class="col-12 mb-3" align="center">
                  <div id="jg_desktop_home_eskimi_728x90" class="pg-loaded" data-google-query-id="CNWW4t6xkvUCFTrocwEdXdEHww" style={{ margin: "20px 0px 35px", textAlign: "center" }}><div id="google_ads_iframe_/21711891156/jg_desktop_home_eskimi_728x90_0__container__" style={{ border: "0pt none" }}><iframe id="google_ads_iframe_/21711891156/jg_desktop_home_eskimi_728x90_0" title="3rd party ad content" name="google_ads_iframe_/21711891156/jg_desktop_home_eskimi_728x90_0" width="728" height="90" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" role="region" aria-label="Advertisement" tabindex="0" sandbox="allow-forms allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" allow="attribution-reporting" srcdoc="" style={{ border: "0px, verticalAlign: bottom" }} data-google-container-id="c" data-load-complete="true"></iframe></div></div>
                </div>
              </div>
              ...
              <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2">
                <div id="category" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/international">
                      <div class="float-left">আন্তর্জাতিক</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row mt-2">
                    <div class="col-md-12">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/covid-19/504357/করোনার-তৃতীয়-ঢেউয়েও-লকডাউন-দেবে-না-ভারত" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" alt="করোনার তৃতীয় ঢেউয়েও লকডাউন দেবে না ভারত!" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504357-1641101254.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">করোনার তৃতীয় ঢেউয়েও লকডাউন দেবে না ভারত!</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card  border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/covid-19/504357/করোনার-তৃতীয়-ঢেউয়েও-লকডাউন-দেবে-না-ভারত" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" alt="করোনার তৃতীয় ঢেউয়েও লকডাউন দেবে না ভারত!" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504357-1641101254.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">করোনার তৃতীয় ঢেউয়েও লকডাউন দেবে না ভারত!</h3>
                          </div>
                  ...
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/international/504354/কাশ্মীরের-সাবেক-৩-মুখ্যমন্ত্রী-গৃহবন্দি&nbsp;" class="text-decoration-none">
                          <img loading="lazy" alt="কাশ্মীরের সাবেক ৩ মুখ্যমন্ত্রী গৃহবন্দি&nbsp;" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504354-1641099581.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/international/504354/কাশ্মীরের-সাবেক-৩-মুখ্যমন্ত্রী-গৃহবন্দি&nbsp;" class="text-decoration-none">
                  ...
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/international/504345/ভারতে-কমলা-হ্যারিসের-মায়ের-নামে-স্কুল" class="text-decoration-none">
                          <img loading="lazy" alt="ভারতে কমলা হ্যারিসের মায়ের নামে স্কুল" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504345-1641096868.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/international/504345/ভারতে-কমলা-হ্যারিসের-মায়ের-নামে-স্কুল" class="text-decoration-none">
                          <h6 class="tab-news-title">ভারতে কমলা হ্যারিসের মায়ের নামে স্কুল</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/international/504335/ভারতের-হরিয়ানায়-খনিধসে-নিহত-৪-নিখোঁজ-১২" class="text-decoration-none">
                          <img loading="lazy" alt="ভারতের হারিয়ানায় খনিধসে নিহত ৪, নিখোঁজ ১২" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504335-1641089337.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/international/504335/ভারতের-হরিয়ানায়-খনিধসে-নিহত-৪-নিখোঁজ-১২" class="text-decoration-none">
                          <h6 class="tab-news-title">ভারতের হরিয়ানায় খনিধসে নিহত ৪, নিখোঁজ ১২</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/ten-horizon/504191/মহারাষ্ট্রের-১০-মন্ত্রী-করোনা-আক্রান্ত" class="text-decoration-none">
                          <img loading="lazy" alt="মহারাষ্ট্রের ১০ মন্ত্রী করোনা আক্রান্ত" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504191-1641086375.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/ten-horizon/504191/মহারাষ্ট্রের-১০-মন্ত্রী-করোনা-আক্রান্ত" class="text-decoration-none">
                          <h6 class="tab-news-title">মহারাষ্ট্রের ১০ মন্ত্রী করোনা আক্রান্ত</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div id="category" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/country-news">
                      <div class="float-left">সারাদেশ</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row mt-2">
                    <div class="col-md-12">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/country-news/504356/টেকনাফে-অস্ত্রসহ-যুবক-আটক" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" alt="আটক" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504356-1641101027.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">টেকনাফে অস্ত্রসহ যুবক আটক</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card  border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/country-news/504356/টেকনাফে-অস্ত্রসহ-যুবক-আটক" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" alt="আটক" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504356-1641101027.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">টেকনাফে অস্ত্রসহ যুবক আটক</h3>
                          </div>
                  ...
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/country-news/504352/নানাবাড়িতে-একাধিকবার-ধর্ষণে-অন্তঃসত্ত্বা-কিশোরী-অতঃপর..." class="text-decoration-none">
                          <img loading="lazy" alt="ধর্ষণ" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504352-1641099046.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/country-news/504352/নানাবাড়িতে-একাধিকবার-ধর্ষণে-অন্তঃসত্ত্বা-কিশোরী-অতঃপর..." class="text-decoration-none">
                  ...
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/country-news/504349/ছাগল-খেতে-এসে-ঢাকায়-ধরা-পড়ল-সুন্দরবনের-বাঘ-ভিডিও" class="text-decoration-none">
                          <span class="rounded-circle border border-white vid-icon-xs overflow-hidden text-center pt-2 pl-1 ml-4 mt-2">
                            <i class="fas fa-play fa-1x text-white"></i>
                          </span>
                          <img loading="lazy" alt="বাঘ" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504349-1641098187.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/country-news/504349/ছাগল-খেতে-এসে-ঢাকায়-ধরা-পড়ল-সুন্দরবনের-বাঘ-ভিডিও" class="text-decoration-none">
                          <h6 class="tab-news-title">ছাগল খেতে এসে ঢাকায় ধরা পড়ল সুন্দরবনের বাঘ (ভিডিও)</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/country-news/504348/চট্টগ্রামে-করোনাভাইরাসে-আক্রান্ত-১৬&nbsp;" class="text-decoration-none">
                          <img loading="lazy" alt="করোনা" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504348-1641097852.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/country-news/504348/চট্টগ্রামে-করোনাভাইরাসে-আক্রান্ত-১৬&nbsp;" class="text-decoration-none">
                          <h6 class="tab-news-title">চট্টগ্রামে করোনাভাইরাসে আক্রান্ত ১৬&nbsp;</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/country-news/504346/সুনামগঞ্জে-ট্রাকচাপায়-অটোরিকশার-২-যাত্রী-নিহত" class="text-decoration-none">
                          <img loading="lazy" alt="সড়ক ‍দুর্ঘটনা" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504346-1641097469.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/country-news/504346/সুনামগঞ্জে-ট্রাকচাপায়-অটোরিকশার-২-যাত্রী-নিহত" class="text-decoration-none">
                          <h6 class="tab-news-title">সুনামগঞ্জে ট্রাকচাপায় অটোরিকশার ২ যাত্রী নিহত</h6>
                        </a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row row-cols-1">
                <div id="category" class="col">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/sports">
                      <div class="float-left">খেলা</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 pt-2 pt-sm-2 pt-md-2 pt-lg-2 pt-xl-2">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/sports/504353/সৌম্যের-সেই-রেকর্ডে-ভাগ-বসালেন-সাদমান" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" class="card-img rounded-0 w-100 d-block" alt="সৌম্যের সেই রেকর্ডে ভাগ বসালেন সাদমান" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504353-1641099419.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">সৌম্যের সেই রেকর্ডে ভাগ বসালেন সাদমান</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card top_lead_card_type-2 border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/sports/504353/সৌম্যের-সেই-রেকর্ডে-ভাগ-বসালেন-সাদমান" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" class="card-img rounded-0 w-100 d-block" alt="সৌম্যের সেই রেকর্ডে ভাগ বসালেন সাদমান" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504353-1641099419.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">সৌম্যের সেই রেকর্ডে ভাগ বসালেন সাদমান</h3>
                            <p class="card-text">
                              নিউজিল্যান্ড টেস্টে দারুণ চারটি ক্যাচ ধরেছেন সাদমান ইসলাম...
                            </p>
                          </div>
                        </a>
                      </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-none d-sm-none d-md-block d-lg-block d-xl-block pt-2 pt-sm-2 pt-md-2 pt-lg-2 pt-xl-2">
                      <div class="row">
                        <div class="col-6">
                          <a href="https://www.jugantor.com/sports/504347/দুই-অর্ধশতকে-ভর-করে-দারুণ-লড়াইয়ে-বাংলাদেশ">
                            <figure class="figure">
                              <img loading="lazy" alt="দুই অর্ধশতকে ভর করে দারুণ লড়াইয়ে বাংলাদেশ" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504347-1641097786.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">দুই অর্ধশতকে ভর করে দারুণ লড়াইয়ে বাংলাদেশ</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="https://www.jugantor.com/sports/504342/ধোনিকে-নিয়ে-বিতর্কিত-মন্তব্য-করলেন-হরভজন">
                            <figure class="figure">
                              <img loading="lazy" alt="ধোনিকে নিয়ে ‘বিতর্কিত’ মন্তব্য করলেন হরভজন" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504342-1641095731.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">ধোনিকে নিয়ে ‘বিতর্কিত’ মন্তব্য করলেন হরভজন</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="https://www.jugantor.com/sports/504338/প্রথম-ইনিংসে-৩২৮-রান-করেছে-নিউজিল্যান্ড">
                            <figure class="figure">
                              <img loading="lazy" alt="প্রথম ইনিংসে ৩২৮ রান করেছে নিউজিল্যান্ড" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504338-1641092223.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">প্রথম ইনিংসে ৩২৮ রান করেছে নিউজিল্যান্ড</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="https://www.jugantor.com/todays-paper/sports/504240/নিজের-আঙিনায়-সেঞ্চুরির-আনন্দ">
                            <figure class="figure">
                              <img loading="lazy" alt="নিজের আঙিনায় সেঞ্চুরির আনন্দ" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504240-1641098225.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">নিজের আঙিনায় সেঞ্চুরির আনন্দ</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="w-100 d-md-block d-lg-block d-xl-block"></div>
                      </div>
                    </div>


                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-md-none d-lg-none d-xl-none">
                      <div id="news-list" class="d-table mt-2">
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/sports/504347/দুই-অর্ধশতকে-ভর-করে-দারুণ-লড়াইয়ে-বাংলাদেশ" class="text-decoration-none">
                              <img loading="lazy" alt="দুই অর্ধশতকে ভর করে দারুণ লড়াইয়ে বাংলাদেশ" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504347-1641097786.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/sports/504347/দুই-অর্ধশতকে-ভর-করে-দারুণ-লড়াইয়ে-বাংলাদেশ" class="text-decoration-none">
                              <h6 class="tab-news-title">দুই অর্ধশতকে ভর করে দারুণ লড়াইয়ে বাংলাদেশ</h6>
                            </a>
                          </div>
                        </div>
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/sports/504342/ধোনিকে-নিয়ে-বিতর্কিত-মন্তব্য-করলেন-হরভজন" class="text-decoration-none">
                              <img loading="lazy" alt="ধোনিকে নিয়ে ‘বিতর্কিত’ মন্তব্য করলেন হরভজন" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504342-1641095731.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/sports/504342/ধোনিকে-নিয়ে-বিতর্কিত-মন্তব্য-করলেন-হরভজন" class="text-decoration-none">
                              <h6 class="tab-news-title">ধোনিকে নিয়ে ‘বিতর্কিত’ মন্তব্য করলেন হরভজন</h6>
                            </a>
                          </div>
                        </div>
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/sports/504338/প্রথম-ইনিংসে-৩২৮-রান-করেছে-নিউজিল্যান্ড" class="text-decoration-none">
                              <img loading="lazy" alt="প্রথম ইনিংসে ৩২৮ রান করেছে নিউজিল্যান্ড" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504338-1641092223.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/sports/504338/প্রথম-ইনিংসে-৩২৮-রান-করেছে-নিউজিল্যান্ড" class="text-decoration-none">
                              <h6 class="tab-news-title">প্রথম ইনিংসে ৩২৮ রান করেছে নিউজিল্যান্ড</h6>
                            </a>
                          </div>
                        </div>
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/todays-paper/sports/504240/নিজের-আঙিনায়-সেঞ্চুরির-আনন্দ" class="text-decoration-none">
                              <img loading="lazy" alt="নিজের আঙিনায় সেঞ্চুরির আনন্দ" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504240-1641098225.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/todays-paper/sports/504240/নিজের-আঙিনায়-সেঞ্চুরির-আনন্দ" class="text-decoration-none">
                              <h6 class="tab-news-title">নিজের আঙিনায় সেঞ্চুরির আনন্দ</h6>
                            </a>
                          </div>
                        </div>
                      </div>
              ...
              <div class="row d-none d-sm-none d-md-block d-lg-block d-xl-block">
                <div class="col-12 mb-3" align="center">
                  <div id="jg_desktop_homecateg_mid2" class="pg-loaded" data-google-query-id="CJL7iOCxkvUCFeMytwAdaqMDzg" style={{ margin: "20px 0px 35px", textAlign: "center" }}><div id="google_ads_iframe_/21711891156/jg_desktop_homecateg_mid2_0__container__" style={{ border: "0pt none" }}><iframe id="google_ads_iframe_/21711891156/jg_desktop_homecateg_mid2_0" title="3rd party ad content" name="google_ads_iframe_/21711891156/jg_desktop_homecateg_mid2_0" width="728" height="90" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" role="region" aria-label="Advertisement" tabindex="0" sandbox="allow-forms allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" allow="attribution-reporting" srcdoc="" style={{ border: "0px, verticalAlign: bottom" }} data-google-container-id="e" data-load-complete="true"></iframe></div></div>
                </div>
              </div>
              ...
              <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2">
                <div id="category" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/tech">
                      <div class="float-left">আইটি বিশ্ব</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row mt-2">
                    <div class="col-md-12">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/todays-paper/it-world/504177/টেলিগ্রামে-একাধিক-ফিচার" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" alt="টেলিগ্রামে একাধিক ফিচার" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504177-1641101149.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">টেলিগ্রামে একাধিক ফিচার</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card  border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/todays-paper/it-world/504177/টেলিগ্রামে-একাধিক-ফিচার" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" alt="টেলিগ্রামে একাধিক ফিচার" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504177-1641101149.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">টেলিগ্রামে একাধিক ফিচার</h3>
                          </div>
                  ...
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/it-world/504176/আন্তর্জাতিক-প্রতিযোগিতায়-চ্যাম্পিয়ন-বাংলাদেশি-অক্সিজেট" class="text-decoration-none">
                          <img loading="lazy" alt="আন্তর্জাতিক প্রতিযোগিতায় চ্যাম্পিয়ন বাংলাদেশি ‘অক্সিজেট’" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504176-1641101110.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/it-world/504176/আন্তর্জাতিক-প্রতিযোগিতায়-চ্যাম্পিয়ন-বাংলাদেশি-অক্সিজেট" class="text-decoration-none">
                          <h6 class="tab-news-title">আন্তর্জাতিক প্রতিযোগিতায় চ্যাম্পিয়ন বাংলাদেশি ‘অক্সিজেট’</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/it-world/504175/নতুন-বছরের-প্রথম-মাসেই-দুই-প্রযুক্তি-মেলা" class="text-decoration-none">
                          <img loading="lazy" alt="নতুন বছরের প্রথম মাসেই দুই প্রযুক্তি মেলা" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504175-1641101069.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/it-world/504175/নতুন-বছরের-প্রথম-মাসেই-দুই-প্রযুক্তি-মেলা" class="text-decoration-none">
                          <h6 class="tab-news-title">নতুন বছরের প্রথম মাসেই দুই প্রযুক্তি মেলা</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/it-world/504174/ডিজেবল-হয়ে-যাচ্ছে-ফেসবুক-অ্যাকাউন্ট-যা-করণীয়" class="text-decoration-none">
                          <img loading="lazy" alt="ডিজেবল হয়ে যাচ্ছে ফেসবুক অ্যাকাউন্ট যা করণীয়" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504174-1641101022.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/it-world/504174/ডিজেবল-হয়ে-যাচ্ছে-ফেসবুক-অ্যাকাউন্ট-যা-করণীয়" class="text-decoration-none">
                          <h6 class="tab-news-title">ডিজেবল হয়ে যাচ্ছে ফেসবুক অ্যাকাউন্ট যা করণীয়</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/international/504123/স্যাটেলাইট-নিজেই-তুলল-সেলফি" class="text-decoration-none">
                          <img loading="lazy" alt="স্যাটেলাইট" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504123-1641051619.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/international/504123/স্যাটেলাইট-নিজেই-তুলল-সেলফি" class="text-decoration-none">
                          <h6 class="tab-news-title">স্যাটেলাইট নিজেই তুলল সেলফি!</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div id="category" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/economics">
                      <div class="float-left">অর্থনীতি</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row mt-2">
                    <div class="col-md-12">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/economics/504350/সূচকের-উত্থানে-চলছে-পুঁজিবাজারে-লেনদেন" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" alt="সূচকের উত্থানে চলছে পুঁজিবাজারে লেনদেন" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504350-1641098393.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">সূচকের উত্থানে চলছে পুঁজিবাজারে লেনদেন</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card  border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/economics/504350/সূচকের-উত্থানে-চলছে-পুঁজিবাজারে-লেনদেন" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" alt="সূচকের উত্থানে চলছে পুঁজিবাজারে লেনদেন" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504350-1641098393.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">সূচকের উত্থানে চলছে পুঁজিবাজারে লেনদেন</h3>
                          </div>
                  ...
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/second-edition/504305/বেড়েছে-ব্যাংকের-পরিচালন-মুনাফা" class="text-decoration-none">
                          <img loading="lazy" alt="বেড়েছে ব্যাংকের পরিচালন মুনাফা" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504305-1641085891.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/second-edition/504305/বেড়েছে-ব্যাংকের-পরিচালন-মুনাফা" class="text-decoration-none">
                          <h6 class="tab-news-title">বেড়েছে ব্যাংকের পরিচালন মুনাফা</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/window/504172/পাঁচ-দশকে-বাংলাদেশ-ব্যাংক" class="text-decoration-none">
                          <img loading="lazy" alt="বাংলাদেশ ব্যাংক" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504172-1641076257.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/window/504172/পাঁচ-দশকে-বাংলাদেশ-ব্যাংক" class="text-decoration-none">
                          <h6 class="tab-news-title">পাঁচ দশকে বাংলাদেশ ব্যাংক</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/capital/504043/ঢাকার-পূর্বাচলে-আন্তর্জাতিক-বাণিজ্য-মেলা-শুরু" class="text-decoration-none">
                          <img loading="lazy" alt="বাণিজ্য মেলা" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504043-1641016491.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/capital/504043/ঢাকার-পূর্বাচলে-আন্তর্জাতিক-বাণিজ্য-মেলা-শুরু" class="text-decoration-none">
                          <h6 class="tab-news-title">ঢাকার পূর্বাচলে আন্তর্জাতিক বাণিজ্য মেলা শুরু</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/last-page/503841/বাণিজ্য-মেলার-পর্দা-উঠছে-আজ" class="text-decoration-none">
                          <img loading="lazy" alt="আন্তর্জাতিক বাণিজ্য মেলা" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-503841-1640980767.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/last-page/503841/বাণিজ্য-মেলার-পর্দা-উঠছে-আজ" class="text-decoration-none">
                          <h6 class="tab-news-title">বাণিজ্য মেলার পর্দা উঠছে আজ</h6>
                        </a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2">
                <div id="category" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/capital">
                      <div class="float-left">রাজধানী</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row mt-2">
                    <div class="col-md-12">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/capital/504351/ঢাকায়-ইয়াবাগাঁজাসহ-গ্রেফতার-৩১" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" alt="প্রতীকী ছবি" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504351-1641098878.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">ঢাকায় ইয়াবা-গাঁজাসহ গ্রেফতার ৩১</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card  border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/capital/504351/ঢাকায়-ইয়াবাগাঁজাসহ-গ্রেফতার-৩১" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" alt="প্রতীকী ছবি" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504351-1641098878.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">ঢাকায় ইয়াবা-গাঁজাসহ গ্রেফতার ৩১</h3>
                          </div>
                  ...
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/capital/504343/রাজধানীতে-পিকআপভ্যানের-ধাক্কায়-যুবক-নিহত" class="text-decoration-none">
                          <img loading="lazy" alt="প্রতীকী ছবি" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504343-1641096046.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/capital/504343/রাজধানীতে-পিকআপভ্যানের-ধাক্কায়-যুবক-নিহত" class="text-decoration-none">
                          <h6 class="tab-news-title">রাজধানীতে পিকআপভ্যানের ধাক্কায় যুবক নিহত</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/second-edition/504313/মোহাম্মদপুরে-মধ্যরাতে-কিশোর-গ্যাংয়ের-তাণ্ডবে-আতঙ্ক" class="text-decoration-none">
                          <img loading="lazy" alt="প্রতীকী ছবি" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504313-1641094370.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/second-edition/504313/মোহাম্মদপুরে-মধ্যরাতে-কিশোর-গ্যাংয়ের-তাণ্ডবে-আতঙ্ক" class="text-decoration-none">
                          <h6 class="tab-news-title">মোহাম্মদপুরে মধ্যরাতে কিশোর গ্যাংয়ের তাণ্ডবে আতঙ্ক</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/capital/504140/রাজধানীতে-ছাত্রলীগ-নেতাকর্মীর-ওপর-ছিনতাইকারীর-হামলা" class="text-decoration-none">
                          <img loading="lazy" alt="রাজধানীতে ছাত্রলীগ নেতাকর্মীর ওপর ছিনতাইকারীর হামলা" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504140-1641055219.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/capital/504140/রাজধানীতে-ছাত্রলীগ-নেতাকর্মীর-ওপর-ছিনতাইকারীর-হামলা" class="text-decoration-none">
                          <h6 class="tab-news-title">রাজধানীতে ছাত্রলীগ নেতাকর্মীর ওপর ছিনতাইকারীর হামলা</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/capital/504100/এ্যাপোলো-ইন্টারন্যাশনালের-৫ম-বর্ষপূর্তি" class="text-decoration-none">
                          <img loading="lazy" alt="এ্যাপোলো ইন্টারন্যাশনাল" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504100-1641042665.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/capital/504100/এ্যাপোলো-ইন্টারন্যাশনালের-৫ম-বর্ষপূর্তি" class="text-decoration-none">
                          <h6 class="tab-news-title">এ্যাপোলো ইন্টারন্যাশনালের ৫ম বর্ষপূর্তি</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div id="category" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/exile">
                      <div class="float-left">পরবাস</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row mt-2">
                    <div class="col-md-12">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/exile/504292/সুইস-এর-সংসদ-সদস্যকে-প্যারিসে-ইউরোবাংলা-প্রেসক্লাবের-সম্মাননা-প্রদান" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" alt="সম্মাননা" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504292-1641078186.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">সুইস এর সংসদ সদস্যকে প্যারিসে ইউরো-বাংলা প্রেসক্লাবের সম্মাননা প্রদান</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card  border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/exile/504292/সুইস-এর-সংসদ-সদস্যকে-প্যারিসে-ইউরোবাংলা-প্রেসক্লাবের-সম্মাননা-প্রদান" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" alt="সম্মাননা" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504292-1641078186.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">সুইস এর সংসদ সদস্যকে প্যারিসে ইউরো-বাংলা প্রেসক্লাবের সম্মাননা প্রদান</h3>
                          </div>
                  ...
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/exile/504291/ইউরোপ-বাংলাদেশ-প্রেস-ক্লাবের-কমিটি-গঠন-সভাপতি-জমির-সম্পাদক-কবির" class="text-decoration-none">
                          <img loading="lazy" alt="কমিটি গঠন&nbsp;" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504291-1641077933.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/exile/504291/ইউরোপ-বাংলাদেশ-প্রেস-ক্লাবের-কমিটি-গঠন-সভাপতি-জমির-সম্পাদক-কবির" class="text-decoration-none">
                          <h6 class="tab-news-title">ইউরোপ বাংলাদেশ প্রেস ক্লাবের কমিটি গঠন সভাপতি জমির সম্পাদক কবির</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/exile/504253/আমিরাতে-ইংরেজি-নববর্ষকে-বরণ" class="text-decoration-none">
                          <img loading="lazy" alt="বরণ" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504253-1641076675.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/exile/504253/আমিরাতে-ইংরেজি-নববর্ষকে-বরণ" class="text-decoration-none">
                          <h6 class="tab-news-title">আমিরাতে ইংরেজি নববর্ষকে বরণ</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/exile/504238/কানাডায়-অন্টারিও-আওয়ামী-লীগের-উদ্যোগে-আলোচনা-সভা" class="text-decoration-none">
                          <img loading="lazy" alt="আলোচনা সভা" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504238-1641075340.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/exile/504238/কানাডায়-অন্টারিও-আওয়ামী-লীগের-উদ্যোগে-আলোচনা-সভা" class="text-decoration-none">
                          <h6 class="tab-news-title">কানাডায় অন্টারিও আওয়ামী লীগের উদ্যোগে আলোচনা সভা</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/exile/504198/বাংলাদেশিদের-চেহারা-ভেসে-উঠে-সুপ্রভাত-মিশিগানে" class="text-decoration-none">
                          <img loading="lazy" alt="সুপ্রভাত" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504198-1641069735.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/exile/504198/বাংলাদেশিদের-চেহারা-ভেসে-উঠে-সুপ্রভাত-মিশিগানে" class="text-decoration-none">
                          <h6 class="tab-news-title">বাংলাদেশিদের চেহারা ভেসে উঠে সুপ্রভাত মিশিগানে</h6>
                        </a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row row-cols-1">
                <div id="category" class="col">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/islam-life">
                      <div class="float-left">ইসলাম ও জীবন</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 pt-2 pt-sm-2 pt-md-2 pt-lg-2 pt-xl-2">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/islam-life/504044/সৃষ্টিকর্তার-স্মরণে-হোক-নতুন-বছরের-পথচলা" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" class="card-img rounded-0 w-100 d-block" alt="সৃষ্টিকর্তার স্মরণে হোক নতুন বছরের পথচলা" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504044-1641018586.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">সৃষ্টিকর্তার স্মরণে হোক নতুন বছরের পথচলা</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card top_lead_card_type-2 border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/islam-life/504044/সৃষ্টিকর্তার-স্মরণে-হোক-নতুন-বছরের-পথচলা" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" class="card-img rounded-0 w-100 d-block" alt="সৃষ্টিকর্তার স্মরণে হোক নতুন বছরের পথচলা" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504044-1641018586.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">সৃষ্টিকর্তার স্মরণে হোক নতুন বছরের পথচলা</h3>
                            <p class="card-text">
                              শুরুতেই রইল নতুন বছরের শুভেচ্ছা ও মোবারকবাদ। সৃষ্টিকর্তার...
                            </p>
                          </div>
                        </a>
                      </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-none d-sm-none d-md-block d-lg-block d-xl-block pt-2 pt-sm-2 pt-md-2 pt-lg-2 pt-xl-2">
                      <div class="row">
                        <div class="col-6">
                          <a href="https://www.jugantor.com/todays-paper/features/islam-and-life/503560/ইউসুফ-নবির-কাহিনি-ও-আমাদের-শিক্ষা">
                            <figure class="figure">
                              <img loading="lazy" alt="আল্লাহতায়ালা বলেন, (হে নবি!) এ অন্য নবি-রাসূলদের বৃত্তান্ত, যা আমি তোমাকে শোনাচ্ছি, এসব এমন জিনিস যার মাধ্যমে আমি তোমার হৃদয়কে মজবুত করি। এ সবের মধ্যে তুমি পেয়েছ সত্যের জ্ঞান এবং ইমানদাররা পেয়েছে উপদেশ ও জাগরণবাণী (সূরা হুদ, আয়াত ১২০)।" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503560-1640933532.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">ইউসুফ নবির কাহিনি ও আমাদের শিক্ষা</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="https://www.jugantor.com/todays-paper/features/islam-and-life/503559/মুমিনের-নববর্ষ">
                            <figure class="figure">
                              <img loading="lazy" alt="মুমিনের নববর্ষ" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503559-1640933668.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">মুমিনের নববর্ষ</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="https://www.jugantor.com/todays-paper/features/islam-and-life/503557/খোদার-রহমতে-সিক্ত-হোক-আমাদের-জীবন">
                            <figure class="figure">
                              <img loading="lazy" alt="মহান আল্লাহর অশেষ রহমত পৃথিবীকে বেষ্টন করে আছে। তিনি রহমতের বিস্তৃতি সম্পর্কে ঘোষণা করেছেন, ‘আমার রহমত প্রতিটি বস্তুকে পরিবেষ্টন করে রেখেছে।’ (সূরা আ’রাফ : আয়াত : ১৫৬)।" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503557-1640933774.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">খোদার রহমতে সিক্ত হোক আমাদের জীবন</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="https://www.jugantor.com/todays-paper/features/islam-and-life/503556/এবার-যাদের-হারালাম">
                            <figure class="figure">
                              <img loading="lazy" alt="এবার যাদের হারালাম" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503556-1640933892.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">এবার যাদের হারালাম</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="w-100 d-md-block d-lg-block d-xl-block"></div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-md-none d-lg-none d-xl-none">
                      <div id="news-list" class="d-table mt-2">
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/todays-paper/features/islam-and-life/503560/ইউসুফ-নবির-কাহিনি-ও-আমাদের-শিক্ষা" class="text-decoration-none">
                              <img loading="lazy" alt="আল্লাহতায়ালা বলেন, (হে নবি!) এ অন্য নবি-রাসূলদের বৃত্তান্ত, যা আমি তোমাকে শোনাচ্ছি, এসব এমন জিনিস যার মাধ্যমে আমি তোমার হৃদয়কে মজবুত করি। এ সবের মধ্যে তুমি পেয়েছ সত্যের জ্ঞান এবং ইমানদাররা পেয়েছে উপদেশ ও জাগরণবাণী (সূরা হুদ, আয়াত ১২০)।" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503560-1640933532.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/todays-paper/features/islam-and-life/503560/ইউসুফ-নবির-কাহিনি-ও-আমাদের-শিক্ষা" class="text-decoration-none">
                              <h6 class="tab-news-title">ইউসুফ নবির কাহিনি ও আমাদের শিক্ষা</h6>
                            </a>
                          </div>
                        </div>
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/todays-paper/features/islam-and-life/503559/মুমিনের-নববর্ষ" class="text-decoration-none">
                              <img loading="lazy" alt="মুমিনের নববর্ষ" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503559-1640933668.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/todays-paper/features/islam-and-life/503559/মুমিনের-নববর্ষ" class="text-decoration-none">
                              <h6 class="tab-news-title">মুমিনের নববর্ষ</h6>
                            </a>
                          </div>
                        </div>
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/todays-paper/features/islam-and-life/503557/খোদার-রহমতে-সিক্ত-হোক-আমাদের-জীবন" class="text-decoration-none">
                              <img loading="lazy" alt="মহান আল্লাহর অশেষ রহমত পৃথিবীকে বেষ্টন করে আছে। তিনি রহমতের বিস্তৃতি সম্পর্কে ঘোষণা করেছেন, ‘আমার রহমত প্রতিটি বস্তুকে পরিবেষ্টন করে রেখেছে।’ (সূরা আ’রাফ : আয়াত : ১৫৬)।" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503557-1640933774.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/todays-paper/features/islam-and-life/503557/খোদার-রহমতে-সিক্ত-হোক-আমাদের-জীবন" class="text-decoration-none">
                              <h6 class="tab-news-title">খোদার রহমতে সিক্ত হোক আমাদের জীবন</h6>
                            </a>
                          </div>
                        </div>
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/todays-paper/features/islam-and-life/503556/এবার-যাদের-হারালাম" class="text-decoration-none">
                              <img loading="lazy" alt="এবার যাদের হারালাম" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503556-1640933892.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/todays-paper/features/islam-and-life/503556/এবার-যাদের-হারালাম" class="text-decoration-none">
                              <h6 class="tab-news-title">এবার যাদের হারালাম</h6>
                            </a>
                          </div>
                        </div>
                      </div>
              ...
              <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2">
                <div id="category" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/bicchu">
                      <div class="float-left">বিচ্ছু</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row mt-2">
                    <div class="col-md-12">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/bicchu/503798/কোরিয়ান-সিনেমায়-বাঙালি-নায়িকা" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" alt="নায়িকা" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503798-1640963963.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">কোরিয়ান সিনেমায় বাঙালি নায়িকা!</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card  border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/bicchu/503798/কোরিয়ান-সিনেমায়-বাঙালি-নায়িকা" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" alt="নায়িকা" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503798-1640963963.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">কোরিয়ান সিনেমায় বাঙালি নায়িকা!</h3>
                          </div>
                  ...
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/features/imp/501935/অবান্তর-প্রশ্ন-যুগান্তর-উত্তর" class="text-decoration-none">
                          <img loading="lazy" alt="অবান্তর" src="https://www.jugantor.com/assets/news_photos/2021/12/26/image-501935-1640690768.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/features/imp/501935/অবান্তর-প্রশ্ন-যুগান্তর-উত্তর" class="text-decoration-none">
                          <h6 class="tab-news-title">অবান্তর প্রশ্ন যুগান্তর উত্তর</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/features/imp/501933/বউ-পাগলা" class="text-decoration-none">
                          <img loading="lazy" alt="বউ পাগলা" src="https://www.jugantor.com/assets/news_photos/2021/12/26/image-501933-1640703014.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/features/imp/501933/বউ-পাগলা" class="text-decoration-none">
                          <h6 class="tab-news-title">বউ পাগলা</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/features/imp/501932/মোবাইল-পীড়া" class="text-decoration-none">
                          <img loading="lazy" alt="মোবাইল পীড়া" src="https://www.jugantor.com/assets/news_photos/2021/12/26/image-501932-1640694438.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/features/imp/501932/মোবাইল-পীড়া" class="text-decoration-none">
                          <h6 class="tab-news-title">মোবাইল পীড়া</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/features/imp/501930/বুদ্ধি" class="text-decoration-none">
                          <img loading="lazy" alt="বিদেশি রস" src="https://www.jugantor.com/assets/news_photos/2021/12/26/image-501930-1640703906.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/features/imp/501930/বুদ্ধি" class="text-decoration-none">
                          <h6 class="tab-news-title">বুদ্ধি</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div id="category" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/various">
                      <div class="float-left">চিত্র বিচিত্র</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row mt-2">
                    <div class="col-md-12">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/international/504031/শতাধিক-বাড়িতে-অগ্নিকাণ্ডের-জন্য-দায়ী-বিড়াল" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" alt="বিড়াল" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504031-1641007533.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">শতাধিক বাড়িতে অগ্নিকাণ্ডের জন্য দায়ী বিড়াল!</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card  border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/international/504031/শতাধিক-বাড়িতে-অগ্নিকাণ্ডের-জন্য-দায়ী-বিড়াল" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" alt="বিড়াল" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504031-1641007533.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">শতাধিক বাড়িতে অগ্নিকাণ্ডের জন্য দায়ী বিড়াল!</h3>
                          </div>
                  ...
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/international/504030/যাত্রীবাহী-গাড়ি-টেনে-নিল-বাঘ-ভিডিও" class="text-decoration-none">
                          <span class="rounded-circle border border-white vid-icon-xs overflow-hidden text-center pt-2 pl-1 ml-4 mt-2">
                            <i class="fas fa-play fa-1x text-white"></i>
                          </span>
                          <img loading="lazy" alt="টাইগার" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504030-1641007003.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/international/504030/যাত্রীবাহী-গাড়ি-টেনে-নিল-বাঘ-ভিডিও" class="text-decoration-none">
                          <h6 class="tab-news-title">যাত্রীবাহী গাড়ি টেনে নিল বাঘ! (ভিডিও)</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/international/504029/নজর-কাড়ল-সবুজ-চোখের-আরেক-আফগান-কন্যা" class="text-decoration-none">
                          <img loading="lazy" alt="আফগান" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-504029-1641006461.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/international/504029/নজর-কাড়ল-সবুজ-চোখের-আরেক-আফগান-কন্যা" class="text-decoration-none">
                          <h6 class="tab-news-title">নজর কাড়ল সবুজ চোখের আরেক আফগান কন্যা</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/international/503718/খাদে-পড়ল-গাড়ি-পাঁচদিন-পর-যেভাবে-বেঁচে-ফিরলেন-নারী" class="text-decoration-none">
                          <span class="rounded-circle border border-white vid-icon-xs overflow-hidden text-center pt-2 pl-1 ml-4 mt-2">
                            <i class="fas fa-play fa-1x text-white"></i>
                          </span>
                          <img loading="lazy" alt="গাড়ি" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503718-1640926217.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/international/503718/খাদে-পড়ল-গাড়ি-পাঁচদিন-পর-যেভাবে-বেঁচে-ফিরলেন-নারী" class="text-decoration-none">
                          <h6 class="tab-news-title">খাদে পড়ল গাড়ি, পাঁচদিন পর যেভাবে বেঁচে ফিরলেন নারী</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/international/503711/কয়েদিদের-মনোরঞ্জনে-নর্তকী-ভাড়া&nbsp;" class="text-decoration-none">
                          <img loading="lazy" alt="কারাগার" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503711-1640924059.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/international/503711/কয়েদিদের-মনোরঞ্জনে-নর্তকী-ভাড়া&nbsp;" class="text-decoration-none">
                          <h6 class="tab-news-title">কয়েদিদের মনোরঞ্জনে নর্তকী ভাড়া!&nbsp;</h6>
                        </a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row row-cols-1 row-cols-sm-1 row-cols-md-3">
                <div id="category" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0 category-slim">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/editorial">
                      <div class="float-left">সম্পাদকীয়</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row mt-2">
                    <div class="col-md-12">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/todays-paper/sub-editorial/504171/শিক্ষিত-তরুণরা-কেন-উৎপাদনে-যুক্ত-হতে-চায়-না" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" alt="শিক্ষিত তরুণ" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504171-1641076185.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">শিক্ষিত তরুণরা কেন উৎপাদনে যুক্ত হতে চায় না</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card  border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/todays-paper/sub-editorial/504171/শিক্ষিত-তরুণরা-কেন-উৎপাদনে-যুক্ত-হতে-চায়-না" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" class="card-img rounded-0 w-100 d-block" alt="শিক্ষিত তরুণ" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504171-1641076185.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">শিক্ষিত তরুণরা কেন উৎপাদনে যুক্ত হতে চায় না</h3>
                          </div>
                        </a>
                  ...
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/sub-editorial/504170/স্বপ্নভঙ্গের-নানা-এপিসোড" class="text-decoration-none">
                          <img loading="lazy" alt="স্বপ্ন" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504170-1641076061.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/sub-editorial/504170/স্বপ্নভঙ্গের-নানা-এপিসোড" class="text-decoration-none">
                          <h6 class="tab-news-title">স্বপ্নভঙ্গের নানা এপিসোড</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/editorial/504169/দুদকের-অভ্যন্তরীণ-দুর্নীতি" class="text-decoration-none">
                          <img loading="lazy" alt="দুদক" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504169-1641075848.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/editorial/504169/দুদকের-অভ্যন্তরীণ-দুর্নীতি" class="text-decoration-none">
                          <h6 class="tab-news-title">দুদকের অভ্যন্তরীণ দুর্নীতি</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/editorial/504168/বিনামূল্যে-বই-বিতরণ-কার্যক্রম" class="text-decoration-none">
                          <img loading="lazy" alt="বই" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504168-1641075540.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/editorial/504168/বিনামূল্যে-বই-বিতরণ-কার্যক্রম" class="text-decoration-none">
                          <h6 class="tab-news-title">বিনামূল্যে বই বিতরণ কার্যক্রম</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/editorial/503851/সবাই-অকৃতকার্য-এসব-শিক্ষাপ্রতিষ্ঠান-টিকিয়ে-রাখার-মাহাত্ম্য-কী" class="text-decoration-none">
                          <img loading="lazy" alt="সবাই অকৃতকার্য! এসব শিক্ষাপ্রতিষ্ঠান টিকিয়ে রাখার মাহাত্ম্য কী?" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-503851-1640989452.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/editorial/503851/সবাই-অকৃতকার্য-এসব-শিক্ষাপ্রতিষ্ঠান-টিকিয়ে-রাখার-মাহাত্ম্য-কী" class="text-decoration-none">
                          <h6 class="tab-news-title">সবাই অকৃতকার্য! এসব শিক্ষাপ্রতিষ্ঠান টিকিয়ে রাখার মাহাত্ম্য কী?</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div id="category" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0 category-slim">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/opinion">
                      <div class="float-left">বাতায়ন</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row mt-2">
                    <div class="col-md-12">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/todays-paper/window/504173/মাধ্যমিক-পরীক্ষার-ফলাফল-মূল্যায়ন" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" alt="মূল্যায়ন" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504173-1641076331.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">মাধ্যমিক পরীক্ষার ফলাফল মূল্যায়ন</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card  border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/todays-paper/window/504173/মাধ্যমিক-পরীক্ষার-ফলাফল-মূল্যায়ন" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" class="card-img rounded-0 w-100 d-block" alt="মূল্যায়ন" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504173-1641076331.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">মাধ্যমিক পরীক্ষার ফলাফল মূল্যায়ন</h3>
                          </div>
                        </a>
                  ...
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/sub-editorial/503853/শুদ্ধ-মন-অশুদ্ধ-কাজ-করতে-পারে-না" class="text-decoration-none">
                          <img loading="lazy" alt="শুদ্ধ মন অশুদ্ধ কাজ করতে পারে না" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-503853-1640990071.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/sub-editorial/503853/শুদ্ধ-মন-অশুদ্ধ-কাজ-করতে-পারে-না" class="text-decoration-none">
                          <h6 class="tab-news-title">শুদ্ধ মন অশুদ্ধ কাজ করতে পারে না</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/sub-editorial/503852/সাধারণ-মানুষের-আশা-পূরণ-হোক-নতুন-বছরে" class="text-decoration-none">
                          <img loading="lazy" alt="সাধারণ মানুষের আশা পূরণ হোক নতুন বছরে" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-503852-1640989786.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/sub-editorial/503852/সাধারণ-মানুষের-আশা-পূরণ-হোক-নতুন-বছরে" class="text-decoration-none">
                          <h6 class="tab-news-title">সাধারণ মানুষের আশা পূরণ হোক নতুন বছরে</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/sub-editorial/503553/কেমন-হবে-নতুন-বছরের-বিশ্বরাজনীতি" class="text-decoration-none">
                          <img loading="lazy" alt="কেমন হবে নতুন বছরের বিশ্বরাজনীতি" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503553-1640905645.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/sub-editorial/503553/কেমন-হবে-নতুন-বছরের-বিশ্বরাজনীতি" class="text-decoration-none">
                          <h6 class="tab-news-title">কেমন হবে নতুন বছরের বিশ্বরাজনীতি</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div id="category" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0 category-slim">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/viewers-opinion">
                      <div class="float-left">দৃষ্টিপাত</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row mt-2">
                    <div class="col-md-12">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/todays-paper/ten-horizon/503857/আরও-ভয়ংকর-হবে-২০২২" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" alt="জলবায়ু" class="card-img rounded-0 w-100 d-block" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-503857-1641023507.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">আরও ভয়ংকর হবে ২০২২</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card  border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/todays-paper/ten-horizon/503857/আরও-ভয়ংকর-হবে-২০২২" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" class="card-img rounded-0 w-100 d-block" alt="জলবায়ু" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-503857-1641023507.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">আরও ভয়ংকর হবে ২০২২</h3>
                          </div>
                        </a>
                  ...
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/window/503855/সোনালি-দিনের-প্রত্যাশা" class="text-decoration-none">
                          <img loading="lazy" alt="জাতীয় পার্টি" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-503855-1640990505.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/window/503855/সোনালি-দিনের-প্রত্যাশা" class="text-decoration-none">
                          <h6 class="tab-news-title">সোনালি দিনের প্রত্যাশা</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/window/503854/হে-নতুন-তবুও-স্বাগত" class="text-decoration-none">
                          <img loading="lazy" alt="নতুন বছর" src="https://www.jugantor.com/assets/news_photos/2022/01/01/image-503854-1640990214.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/window/503854/হে-নতুন-তবুও-স্বাগত" class="text-decoration-none">
                          <h6 class="tab-news-title">হে নতুন, তবুও স্বাগত</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/sub-editorial/503554/হাতি-কি-বিলুপ্ত-হয়ে-যাবে" class="text-decoration-none">
                          <img loading="lazy" alt="হাতি কি বিলুপ্ত হয়ে যাবে?" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503554-1640906180.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/sub-editorial/503554/হাতি-কি-বিলুপ্ত-হয়ে-যাবে" class="text-decoration-none">
                          <h6 class="tab-news-title">হাতি কি বিলুপ্ত হয়ে যাবে?</h6>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div id="news-list" class="d-table mt-2">
                    <div class="d-table-row">
                      <div class="d-table-cell align-middle pr-2 pb-2">
                        <a href="https://www.jugantor.com/todays-paper/little-talk/503550/নিঃশব্দ-ঘাতক" class="text-decoration-none">
                          <img loading="lazy" alt="নিঃশব্দ ঘাতক" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503550-1640934525.jpg" width="90" height="60" />
                        </a>
                      </div>
                      <div class="d-table-cell align-middle pr-2">
                        <a href="https://www.jugantor.com/todays-paper/little-talk/503550/নিঃশব্দ-ঘাতক" class="text-decoration-none">
                          <h6 class="tab-news-title">নিঃশব্দ ঘাতক</h6>
                        </a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row-cols-sm-1 row-cols-md-1">
                <div id="category" class="col">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/lifestyle">
                      <div class="float-left">লাইফ স্টাইল</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 pt-2 pt-sm-2 pt-md-2 pt-lg-2 pt-xl-2">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/doctor-available/504341/মলদ্বারে-ক্যান্সার-হয়েছে-কিনা-বুঝবেন-যেভাবে" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" class="card-img rounded-0 w-100 d-block" alt="মলদ্বারে ক্যান্সার হয়েছে কিনা বুঝবেন যেভাবে" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504341-1641094762.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">মলদ্বারে ক্যান্সার হয়েছে কিনা বুঝবেন যেভাবে</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card top_lead_card_type-2 border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/doctor-available/504341/মলদ্বারে-ক্যান্সার-হয়েছে-কিনা-বুঝবেন-যেভাবে" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" class="card-img rounded-0 w-100 d-block" alt="মলদ্বারে ক্যান্সার হয়েছে কিনা বুঝবেন যেভাবে" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504341-1641094762.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">মলদ্বারে ক্যান্সার হয়েছে কিনা বুঝবেন যেভাবে</h3>
                            <p class="card-text">
                              শীতকালে অনেকেই কোষ্ঠকাঠিন্যের সমস্যায় ভোগেন। &nbsp;এর মূল কারণ...
                            </p>
                          </div>
                        </a>
                      </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-none d-sm-none d-md-block d-lg-block d-xl-block pt-2 pt-sm-2 pt-md-2 pt-lg-2 pt-xl-2">
                      <div class="row">
                        <div class="col-6">
                          <a href="https://www.jugantor.com/doctor-available/504339/৮-লক্ষণে-বুঝবেন-ফুসফুসে-ক্যান্সার">
                            <figure class="figure">
                              <img loading="lazy" alt="৮ লক্ষণে বুঝবেন ফুসফুসে ক্যান্সার" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504339-1641094320.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">৮ লক্ষণে বুঝবেন ফুসফুসে ক্যান্সার</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="https://www.jugantor.com/capital/503786/নিয়োগ-পরীক্ষায়-প্রশ্ন-ফাঁসের-অভিযোগ-পরীক্ষা-বর্জন">
                            <figure class="figure">
                              <img loading="lazy" alt="নিয়োগ" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503786-1640959913.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">নিয়োগ পরীক্ষায় প্রশ্ন ফাঁসের অভিযোগ, পরীক্ষা বর্জন</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="https://www.jugantor.com/doctor-available/503703/প্রাকৃতিক-পদ্ধতিতে-ওজন-কমাবেন-যেভাবে">
                            <figure class="figure">
                              <img loading="lazy" alt="প্রাকৃতিক পদ্ধতিতে ওজন কমাবেন যেভাবে" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503703-1640919769.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">প্রাকৃতিক পদ্ধতিতে ওজন কমাবেন যেভাবে</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="https://www.jugantor.com/lifestyle/503456/দেশসেরা-রন্ধনশিল্পী-হলেন-ফারজানা-শাম্মী">
                            <figure class="figure">
                              <img loading="lazy" alt="দেশসেরা রন্ধনশিল্পী হলেন ফারজানা শাম্মী" src="https://www.jugantor.com/assets/news_photos/2021/12/30/image-503456-1640868022.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">দেশসেরা রন্ধনশিল্পী হলেন ফারজানা শাম্মী</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="w-100 d-md-block d-lg-block d-xl-block"></div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-md-none d-lg-none d-xl-none">
                      <div id="news-list" class="d-table mt-2">
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/doctor-available/504339/৮-লক্ষণে-বুঝবেন-ফুসফুসে-ক্যান্সার" class="text-decoration-none">
                              <img loading="lazy" alt="৮ লক্ষণে বুঝবেন ফুসফুসে ক্যান্সার" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504339-1641094320.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/doctor-available/504339/৮-লক্ষণে-বুঝবেন-ফুসফুসে-ক্যান্সার" class="text-decoration-none">
                              <h6 class="tab-news-title">৮ লক্ষণে বুঝবেন ফুসফুসে ক্যান্সার</h6>
                            </a>
                          </div>
                        </div>
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/capital/503786/নিয়োগ-পরীক্ষায়-প্রশ্ন-ফাঁসের-অভিযোগ-পরীক্ষা-বর্জন" class="text-decoration-none">
                              <img loading="lazy" alt="নিয়োগ" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503786-1640959913.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/capital/503786/নিয়োগ-পরীক্ষায়-প্রশ্ন-ফাঁসের-অভিযোগ-পরীক্ষা-বর্জন" class="text-decoration-none">
                              <h6 class="tab-news-title">নিয়োগ পরীক্ষায় প্রশ্ন ফাঁসের অভিযোগ, পরীক্ষা বর্জন</h6>
                            </a>
                          </div>
                        </div>
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/doctor-available/503703/প্রাকৃতিক-পদ্ধতিতে-ওজন-কমাবেন-যেভাবে" class="text-decoration-none">
                              <img loading="lazy" alt="প্রাকৃতিক পদ্ধতিতে ওজন কমাবেন যেভাবে" src="https://www.jugantor.com/assets/news_photos/2021/12/31/image-503703-1640919769.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/doctor-available/503703/প্রাকৃতিক-পদ্ধতিতে-ওজন-কমাবেন-যেভাবে" class="text-decoration-none">
                              <h6 class="tab-news-title">প্রাকৃতিক পদ্ধতিতে ওজন কমাবেন যেভাবে</h6>
                            </a>
                          </div>
                        </div>
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/lifestyle/503456/দেশসেরা-রন্ধনশিল্পী-হলেন-ফারজানা-শাম্মী" class="text-decoration-none">
                              <img loading="lazy" alt="দেশসেরা রন্ধনশিল্পী হলেন ফারজানা শাম্মী" src="https://www.jugantor.com/assets/news_photos/2021/12/30/image-503456-1640868022.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/lifestyle/503456/দেশসেরা-রন্ধনশিল্পী-হলেন-ফারজানা-শাম্মী" class="text-decoration-none">
                              <h6 class="tab-news-title">দেশসেরা রন্ধনশিল্পী হলেন ফারজানা শাম্মী</h6>
                            </a>
                          </div>
                        </div>
                      </div>
                ...
                <div id="category" class="col">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/everyday">
                      <div class="float-left">একদিন প্রতিদিন</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 pt-2 pt-sm-2 pt-md-2 pt-lg-2 pt-xl-2">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/everyday/503377/৩০-ডিসেম্বের-টিভিতে-আজকের-খেলা-সূচি" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" class="card-img rounded-0 w-100 d-block" alt="৩০ ডিসেম্বের: টিভিতে আজকের খেলা সূচি" src="https://www.jugantor.com/assets/news_photos/2021/12/30/image-503377-1640834509.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">৩০ ডিসেম্বের: টিভিতে আজকের খেলা সূচি</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card top_lead_card_type-2 border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/everyday/503377/৩০-ডিসেম্বের-টিভিতে-আজকের-খেলা-সূচি" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" class="card-img rounded-0 w-100 d-block" alt="৩০ ডিসেম্বের: টিভিতে আজকের খেলা সূচি" src="https://www.jugantor.com/assets/news_photos/2021/12/30/image-503377-1640834509.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">৩০ ডিসেম্বের: টিভিতে আজকের খেলা সূচি</h3>
                            <p class="card-text">
                              একনজরে জেনে নিই টিভি পর্দায় আজ রয়েছে যেসব খেলা-
                            </p>
                          </div>
                        </a>
                      </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-none d-sm-none d-md-block d-lg-block d-xl-block pt-2 pt-sm-2 pt-md-2 pt-lg-2 pt-xl-2">
                      <div class="row">
                        <div class="col-6">
                          <a href="https://www.jugantor.com/everyday/501995/২৬-ডিসেম্বর-টিভিতে-আজকের-খেলা-সূচি">
                            <figure class="figure">
                              <img loading="lazy" alt="২৬ ডিসেম্বর: টিভিতে আজকের খেলা সূচি" src="https://www.jugantor.com/assets/news_photos/2021/12/26/image-501995-1640490650.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">২৬ ডিসেম্বর: টিভিতে আজকের খেলা সূচি</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="https://www.jugantor.com/everyday/501334/২৪-ডিসেম্বর-টিভিতে-আজকের-খেলা-সূচি">
                            <figure class="figure">
                              <img loading="lazy" alt="২৪ ডিসেম্বর: টিভিতে আজকের খেলা সূচি" src="https://www.jugantor.com/assets/news_photos/2021/12/24/image-501334-1640317351.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">২৪ ডিসেম্বর: টিভিতে আজকের খেলা সূচি</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="https://www.jugantor.com/everyday/499980/২০-ডিসেম্বর-টিভিতে-আজকের-খেলা-সূচি">
                            <figure class="figure">
                              <img loading="lazy" alt="২০ ডিসেম্বর: টিভিতে আজকের খেলা সূচি" src="https://www.jugantor.com/assets/news_photos/2021/12/20/image-499980-1639971934.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">২০ ডিসেম্বর: টিভিতে আজকের খেলা সূচি</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="https://www.jugantor.com/everyday/499621/১৯-ডিসেম্বর-টিভিতে-আজকের-খেলা-সূচি">
                            <figure class="figure">
                              <img loading="lazy" alt="১৯ ডিসেম্বর: টিভিতে আজকের খেলা সূচি" src="https://www.jugantor.com/assets/news_photos/2021/12/19/image-499621-1639885324.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">১৯ ডিসেম্বর: টিভিতে আজকের খেলা সূচি</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="w-100 d-md-block d-lg-block d-xl-block"></div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-md-none d-lg-none d-xl-none">
                      <div id="news-list" class="d-table mt-2">
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/everyday/501995/২৬-ডিসেম্বর-টিভিতে-আজকের-খেলা-সূচি" class="text-decoration-none">
                              <img loading="lazy" alt="২৬ ডিসেম্বর: টিভিতে আজকের খেলা সূচি" src="https://www.jugantor.com/assets/news_photos/2021/12/26/image-501995-1640490650.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/everyday/501995/২৬-ডিসেম্বর-টিভিতে-আজকের-খেলা-সূচি" class="text-decoration-none">
                              <h6 class="tab-news-title">২৬ ডিসেম্বর: টিভিতে আজকের খেলা সূচি</h6>
                            </a>
                          </div>
                        </div>
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/everyday/501334/২৪-ডিসেম্বর-টিভিতে-আজকের-খেলা-সূচি" class="text-decoration-none">
                              <img loading="lazy" alt="২৪ ডিসেম্বর: টিভিতে আজকের খেলা সূচি" src="https://www.jugantor.com/assets/news_photos/2021/12/24/image-501334-1640317351.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/everyday/501334/২৪-ডিসেম্বর-টিভিতে-আজকের-খেলা-সূচি" class="text-decoration-none">
                              <h6 class="tab-news-title">২৪ ডিসেম্বর: টিভিতে আজকের খেলা সূচি</h6>
                            </a>
                          </div>
                        </div>
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/everyday/499980/২০-ডিসেম্বর-টিভিতে-আজকের-খেলা-সূচি" class="text-decoration-none">
                              <img loading="lazy" alt="২০ ডিসেম্বর: টিভিতে আজকের খেলা সূচি" src="https://www.jugantor.com/assets/news_photos/2021/12/20/image-499980-1639971934.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/everyday/499980/২০-ডিসেম্বর-টিভিতে-আজকের-খেলা-সূচি" class="text-decoration-none">
                              <h6 class="tab-news-title">২০ ডিসেম্বর: টিভিতে আজকের খেলা সূচি</h6>
                            </a>
                          </div>
                        </div>
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/everyday/499621/১৯-ডিসেম্বর-টিভিতে-আজকের-খেলা-সূচি" class="text-decoration-none">
                              <img loading="lazy" alt="১৯ ডিসেম্বর: টিভিতে আজকের খেলা সূচি" src="https://www.jugantor.com/assets/news_photos/2021/12/19/image-499621-1639885324.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/everyday/499621/১৯-ডিসেম্বর-টিভিতে-আজকের-খেলা-সূচি" class="text-decoration-none">
                              <h6 class="tab-news-title">১৯ ডিসেম্বর: টিভিতে আজকের খেলা সূচি</h6>
                            </a>
                          </div>
                        </div>
                      </div>
                ...
                <div id="category" class="col">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/entertainment">
                      <div class="float-left">বিনোদন</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 pt-2 pt-sm-2 pt-md-2 pt-lg-2 pt-xl-2">
                      <div id="cat-lead" class="card top_lead_card d-md-none d-lg-none d-xl-none">
                        <a href="https://www.jugantor.com/entertainment/504355/জ্যাকুলিনের-সঙ্গে-আমার-সম্পর্ক-ছিল-সুকেশ" class="stretched-link text-decoration-none text-white">
                          <img loading="lazy" class="card-img rounded-0 w-100 d-block" alt="জ্যাকুলিনের সঙ্গে আমার সম্পর্ক ছিল: সুকেশ" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504355-1641100151.jpg" />
                          <div class="card-body overlay_lead pb-0">
                            <h3 class="card-title font-weight-bold">জ্যাকুলিনের সঙ্গে আমার সম্পর্ক ছিল: সুকেশ</h3>
                          </div>
                        </a>
                      </div>
                      <div id="desktop-cat-lead" class="card top_lead_card top_lead_card_type-2 border border-0 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                        <a href="https://www.jugantor.com/entertainment/504355/জ্যাকুলিনের-সঙ্গে-আমার-সম্পর্ক-ছিল-সুকেশ" class="stretched-link text-decoration-none text-dark">
                          <img loading="lazy" class="card-img rounded-0 w-100 d-block" alt="জ্যাকুলিনের সঙ্গে আমার সম্পর্ক ছিল: সুকেশ" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504355-1641100151.jpg" />
                          <div class="card-body pl-0 py-2">
                            <h3 class="card-title font-weight-bold">জ্যাকুলিনের সঙ্গে আমার সম্পর্ক ছিল: সুকেশ</h3>
                            <p class="card-text">
                              বলিউডের হার্টথ্রুব নায়িকা জ্যাকুলিন ফার্নান্দেজের সঙ্গে...
                            </p>
                          </div>
                        </a>
                      </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-none d-sm-none d-md-block d-lg-block d-xl-block pt-2 pt-sm-2 pt-md-2 pt-lg-2 pt-xl-2">
                      <div class="row">
                        <div class="col-6">
                          <a href="https://www.jugantor.com/covid-19/504344/করোনায়-আক্রান্ত-সৃজিত-আইসোলেশনে">
                            <figure class="figure">
                              <img loading="lazy" alt="করোনায় আক্রান্ত সৃজিত আইসোলেশনে" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504344-1641096482.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">করোনায় আক্রান্ত সৃজিত আইসোলেশনে</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="https://www.jugantor.com/entertainment/504302/মেয়ের-ভিডিওতে-চমক-দেখালেন-আনুশকা-ভিডিও">
                            <figure class="figure">
                              <img loading="lazy" alt="আনুশকা" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504302-1641079154.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">মেয়ের ভিডিওতে চমক দেখালেন আনুশকা (ভিডিও)</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="https://www.jugantor.com/entertainment/504293/তোমরাই-আমার-মানসিক-শান্তির-&nbsp;কারণ-প্রভা">
                            <figure class="figure">
                              <img loading="lazy" alt="প্রভা" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504293-1641078960.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">তোমরাই আমার মানসিক শান্তির &nbsp;কারণ: প্রভা</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="https://www.jugantor.com/entertainment/504254/কবে-বিয়ে-করছেন-নুসরাত-ফারিয়া">
                            <figure class="figure">
                              <img loading="lazy" alt="নুসরাত ফারিয়া" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504254-1641076932.jpg" class="figure-img img-fluid" />
                              <figcaption class="figure-caption">কবে বিয়ে করছেন নুসরাত ফারিয়া</figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="w-100 d-md-block d-lg-block d-xl-block"></div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-md-none d-lg-none d-xl-none">
                      <div id="news-list" class="d-table mt-2">
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/covid-19/504344/করোনায়-আক্রান্ত-সৃজিত-আইসোলেশনে" class="text-decoration-none">
                              <img loading="lazy" alt="করোনায় আক্রান্ত সৃজিত আইসোলেশনে" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504344-1641096482.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/covid-19/504344/করোনায়-আক্রান্ত-সৃজিত-আইসোলেশনে" class="text-decoration-none">
                              <h6 class="tab-news-title">করোনায় আক্রান্ত সৃজিত আইসোলেশনে</h6>
                            </a>
                          </div>
                        </div>
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/entertainment/504302/মেয়ের-ভিডিওতে-চমক-দেখালেন-আনুশকা-ভিডিও" class="text-decoration-none">
                              <img loading="lazy" alt="আনুশকা" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504302-1641079154.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/entertainment/504302/মেয়ের-ভিডিওতে-চমক-দেখালেন-আনুশকা-ভিডিও" class="text-decoration-none">
                              <h6 class="tab-news-title">মেয়ের ভিডিওতে চমক দেখালেন আনুশকা (ভিডিও)</h6>
                            </a>
                          </div>
                        </div>
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/entertainment/504293/তোমরাই-আমার-মানসিক-শান্তির-&nbsp;কারণ-প্রভা" class="text-decoration-none">
                              <img loading="lazy" alt="প্রভা" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504293-1641078960.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/entertainment/504293/তোমরাই-আমার-মানসিক-শান্তির-&nbsp;কারণ-প্রভা" class="text-decoration-none">
                              <h6 class="tab-news-title">তোমরাই আমার মানসিক শান্তির &nbsp;কারণ: প্রভা</h6>
                            </a>
                          </div>
                        </div>
                        <div class="d-table-row">
                          <div class="d-table-cell align-middle pr-2 pb-2">
                            <a href="https://www.jugantor.com/entertainment/504254/কবে-বিয়ে-করছেন-নুসরাত-ফারিয়া" class="text-decoration-none">
                              <img loading="lazy" alt="নুসরাত ফারিয়া" src="https://www.jugantor.com/assets/news_photos/2022/01/02/image-504254-1641076932.jpg" width="90" height="60" />
                            </a>
                          </div>
                          <div class="d-table-cell align-middle pr-2">
                            <a href="https://www.jugantor.com/entertainment/504254/কবে-বিয়ে-করছেন-নুসরাত-ফারিয়া" class="text-decoration-none">
                              <h6 class="tab-news-title">কবে বিয়ে করছেন নুসরাত ফারিয়া</h6>
                            </a>
                          </div>
                        </div>
                      </div>
              ...
              <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 pl-0 pl-sm-0 pl-md-3">
                <div id="category" class="col-md-8 pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0 photo-gallery px-lg-0">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/photo-gallery">
                      <div class="float-left">ফটো গ্যালারি</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="carousel slide carousel-fade mt-2" data-ride="carousel" id="carousel-1" data-interval="2000" data-pause="hover">
                    <div class="carousel-inner" role="listbox">
                      <div class="carousel-item">
                        <a href="https://www.jugantor.com/photo-gallery/bangladesh/200/৩১-ডিসেম্বর-২০২১" title="কুড়িগ্রামের ভূরুঙ্গামারীতে সরিষা ক্ষেতে কৃষকের হাসি। ছবি: যুগান্তর">
                          <img src="https://jamuna.jugantor.com/laravel-filemanager/photos/15/10_12_21/Bhurungamari.jpg" loading="lazy" alt="কুড়িগ্রামের ভূরুঙ্গামারীতে সরিষা ক্ষেতে কৃষকের হাসি। ছবি: যুগান্তর" class="img-fluid w-100" />
                          <div class="description">
                            <h5 class="p-2"> কুড়িগ্রামের ভূরুঙ্গামারীতে সরিষা ক্ষেতে কৃষকের হাসি। ছবি: যুগান্তর </h5>
                          </div>
                        </a>
                      </div>
                      <div class="carousel-item">
                        <a href="https://www.jugantor.com/photo-gallery/bangladesh/200/৩১-ডিসেম্বর-২০২১" title="পাবনার চাটমোহর উপজেলার কাটেঙ্গা-বরদানগর এলাকায় গুমানী নদীতে খেয়া নৌকায় ঝুঁকিপূর্ণ পারাপার। ছবি: যুগান্তর">
                          <img src="https://jamuna.jugantor.com/laravel-filemanager/photos/15/10_12_21/Chatmohor.jpg" loading="lazy" alt="পাবনার চাটমোহর উপজেলার কাটেঙ্গা-বরদানগর এলাকায় গুমানী নদীতে খেয়া নৌকায় ঝুঁকিপূর্ণ পারাপার। ছবি: যুগান্তর" class="img-fluid w-100" />
                          <div class="description">
                            <h5 class="p-2"> পাবনার চাটমোহর উপজেলার কাটেঙ্গা-বরদানগর এলাকায় গুমানী নদীতে খেয়া নৌকায় ঝুঁকিপূর্ণ পারাপার। ছবি: যুগান্তর </h5>
                          </div>
                        </a>
                      </div>
                      <div class="carousel-item active">
                        <a href="https://www.jugantor.com/photo-gallery/bangladesh/200/৩১-ডিসেম্বর-২০২১" title="ফরিদপুরের মধুখালী উপজেলার মেগচামী ইউনিয়নের কালীনগরে কৃষকের মাঠে একদল বক। আলোকচিত্রী: শাহজাহান হেলাল">
                          <img src="https://jamuna.jugantor.com/laravel-filemanager/photos/15/10_12_21/Madhukhali-.jpg" loading="lazy" alt="ফরিদপুরের মধুখালী উপজেলার মেগচামী ইউনিয়নের কালীনগরে কৃষকের মাঠে একদল বক। আলোকচিত্রী: শাহজাহান হেলাল" class="img-fluid w-100" />
                          <div class="description">
                            <h5 class="p-2"> ফরিদপুরের মধুখালী উপজেলার মেগচামী ইউনিয়নের কালীনগরে কৃষকের মাঠে একদল বক। আলোকচিত্রী: শাহজাহান হেলাল </h5>
                          </div>
                        </a>
                      </div>
                    </div>
                ...
                <div id="category" class="col-md-4 pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0 video-gallery">
                  <div class="clearfix">
                    <a href="https://www.jugantor.com/video-gallery">
                      <div class="float-left">ভিডিও গ্যালারি</div>
                      <div class="float-right d-md-none d-lg-none d-xl-none"><span>➔</span></div>
                    </a>
                  </div>
                  <div class="row mt-2">
                    <div class="col-md-12">
                      <a href="https://www.jugantor.com/video-gallery/bangladesh/163/পোস্ট-অফিসের-বেহাল-দশা" class="text-decoration-none">
                        <figure class="figure border-bottom pb-2 thumbnail">
                          <i class="fa fa-play fa-lg"></i>
                          <img loading="lazy" src="https://www.jugantor.com/assets/video_cover_photos/2021/12/23/cover_photo-163.jpg" class="figure-img h-100 w-100" alt="পোস্ট অফিসের বেহাল দশা" />
                          <figcaption class="figure-caption font-weight-normal">পোস্ট অফিসের বেহাল দশা</figcaption>
                        </figure>
                      </a>
                    </div>
                  </div>
                  <div class="row my-auto">
                    <div class="col-6 col-sm-6 col-md-6">
                      <a href="https://www.jugantor.com/video-gallery/bangladesh/162/প্রেমের-টানে-তুরস্ক-থেকে-বাংলাদেশে-তরুণী" class="text-decoration-none">
                        <figure class="figure thumbnail">
                          <i class="fa fa-play fa-sm"></i>
                          <img loading="lazy" src="https://www.jugantor.com/assets/video_cover_photos/2021/12/17/cover_photo-162.jpg" class="figure-img img-fluid" alt="প্রেমের টানে তুরস্ক থেকে বাংলাদেশে তরুণী" />
                          <figcaption class="figure-caption font-weight-normal">প্রেমের টানে তুরস্ক থেকে বাংলাদেশে তরুণী</figcaption>
                        </figure>
                      </a>
                    </div>
                    <div class="col-6 col-sm-6 col-md-6">
                      <a href="https://www.jugantor.com/video-gallery/bangladesh/161/ভারতের-আগরতলায়-মুক্তিযুদ্ধের-ক্যাম্প-যেভাবে-পরিচালিত-হতো" class="text-decoration-none">
                        <figure class="figure thumbnail">
                          <i class="fa fa-play fa-sm"></i>
                          <img loading="lazy" src="https://www.jugantor.com/assets/video_cover_photos/2021/12/16/cover_photo-161.jpg" class="figure-img img-fluid" alt="ভারতের আগরতলায় মুক্তিযুদ্ধের ক্যাম্প যেভাবে পরিচালিত হতো" />
                          <figcaption class="figure-caption font-weight-normal">ভারতের আগরতলায় মুক্তিযুদ্ধের ক্যাম্প যেভাবে পরিচালিত হতো</figcaption>
                        </figure>
                      </a>
                    </div>
                  </div>
              ...
              <div class="row d-lg-none d-xl-none mt-2">
                <div class="col-12" align="center">
                  <div id="jg_mobile_homecateg_mid2"></div>
                </div>
              </div>
            ...
            <div class="col-md-4 pt-2 pt-sm-2 pt-md-0 pt-lg-0 pt-xl-0">
              <div class="row row-cols-1">
                <div class="col d-none d-sm-none d-md-block d-lg-block d-xl-block">
                  ...
                  <div class="col-12 mb-3" align="center">
                    <div id="jg_desktop_homecateg_sidebar_direct" class="pg-loaded" style={{ margin: "20px 0px 35px", textAlign: "center" }} data-google-query-id="CO3iya-ykvUCFWAmtwAdeLYD2g">
                      <div id="google_ads_iframe_/21711891156/jg_desktop_homecateg_sidebar_direct_0__container__" style={{ border: "0pt none" }}><iframe id="google_ads_iframe_/21711891156/jg_desktop_homecateg_sidebar_direct_0" title="3rd party ad content" name="google_ads_iframe_/21711891156/jg_desktop_homecateg_sidebar_direct_0" width="300" height="250" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" role="region" aria-label="Advertisement" tabindex="0" allow="attribution-reporting" srcdoc="" data-google-container-id="3" style={{ border: "0px, verticalAlign: bottom" }} data-load-complete="true"></iframe></div></div>
                  </div>


                  <div class="col-12 mb-3" align="center">
                    <div id="jg_desktop_homecateg_sidebar_top" class="pg-loaded" style={{ margin: "20px 0px 35px", textAlign: "center" }} data-google-query-id="CN7tza-ykvUCFbHYcwEdmqwAhg">
                      <div id="google_ads_iframe_/21711891156/jg_desktop_homecateg_sidebar_top_0__container__" style={{ border: "0pt none" }}><iframe id="google_ads_iframe_/21711891156/jg_desktop_homecateg_sidebar_top_0" title="3rd party ad content" name="google_ads_iframe_/21711891156/jg_desktop_homecateg_sidebar_top_0" width="300" height="250" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" role="region" aria-label="Advertisement" tabindex="0" allow="attribution-reporting" srcdoc="" style={{ border: "0px, verticalAlign: bottom" }} data-google-container-id="2" data-load-complete="true"></iframe></div></div>
                  </div>
                  ...
                  <div class="spacebar"></div>
                  <div class="spacebar"></div>
                  <div id="most-recent-news-tab" class="bg-white mb-2 mb-sm-0 mb-md-0 mb-lg-0 mb-xl-0">
                    <ul id="myTab" role="tablist" class="nav nav-tabs nav-pills text-center border-0">
                      <li class="nav-item flex-fill flex-sm-fill pr-2">
                        <a id="home-tab" data-toggle="tab" href="#recent-view-home" role="tab" aria-controls="recent-view" aria-selected="true" class="nav-link border-0 text-uppercase font-weight-bold py-1 active">সর্বশেষ</a>
                      </li>
                      <li class="nav-item flex-fill flex-sm-fill pl-2">
                        <a id="profile-tab" data-toggle="tab" href="#most-view-home" role="tab" aria-controls="most-view" aria-selected="false" class="nav-link border-0 text-uppercase font-weight-bold py-1">সর্বাধিক
                          পঠিত</a>
                      </li>
                    </ul>
                    <div id="news-list" class="tab-content">
                      <div id="recent-view-home" role="tabpanel" aria-labelledby="home-tab" class="tab-pane fade px-0 my-2 show active">
                        <div class="slimScrollDiv" style={{ position: "relative", overflow: "hidden", width: "auto", height: "410px" }}><div id="most-recent-news-home" style={{
                          overflow: "hidden", width: "auto", height: "410px"
                        }}>
                          <div class="row row-cols-1 no-gutters mb-2">
                            <div class="col-3">
                              <a href="https://www.jugantor.com/national/504358/নিষেধাজ্ঞা-প্রত্যাহারে-যুক্তরাষ্ট্রকে-বাংলাদেশের-চিঠি" class="text-decoration-none">
                          ...
                          <div class="slimScrollBar" style={{ background: "rgb(0, 0, 0)", width: "7px", position: "absolute", top: "0px", opacity: "0.4", display: "block", borderRadius: "7px", zIndex: "99", right: "1px", height: "353.151px" }}></div><div class="slimScrollRail" style={{ width: "7px", height: "100%", position: "absolute", top: "0px", display: "none", borderRadius: "7px", background: "rgb(51, 51, 51", opacity: "0.2", zIndex: "90", right: "1px" }}></div></div>
                        <div class="nav nav-pills nav-fill mt-2">
                          <span class="nav-item"><a class="nav-link active py-1 font-weight-bold" href="https://www.jugantor.com/all-news">সব খবর</a></span>
                        </div>
                      </div>
                      <div id="most-view-home" role="tabpanel" aria-labelledby="profile-tab" class="tab-pane fade px-0 my-2">
                        <div class="slimScrollDiv" style={{ position: "relative", overflow: "hidden", width: "auto", height: "410px" }}><div id="most-viewed-news-home" style={{
                          overflow: "hidden", width: "auto", height: "410px"
                        }}>
                          <div class="row row-cols-1 no-gutters mb-2">
                            <div class="col-3">
                          ...
                          <div class="slimScrollBar" style={{ background: "rgb(0, 0, 0)", width: "7px", position: "absolute", top: "0px", opacity: "0.4", display: "block", borderRadius: "7px", zIndex: "99", right: "1px" }}>
                          </div>
                          <div class="slimScrollRail" style={{ width: "7px", height: "100%", position: "absolute", top: "0px", display: "none", borderRadius: "7px", background: "rgb(51, 51, 51", opacity: "0.2", zIndex: "90", right: "1px" }}>
                          </div>
                        </div>
                        <div class="nav nav-pills nav-fill">
                          <span class="nav-item"><a class="nav-link active py-1 font-weight-bold" href="https://www.jugantor.com/all-news/all-most-viewed-news">সব খবর</a></span>
                  ...
                  <div class="col-12 mb-3" align="center">
                    <div id="jg_desktop_homecateg_sidebar_mid" class="pg-loaded" style={{ margin: "20px 0px 35px", textAlign: "center" }} data-google-query-id="CKD47PCvkvUCFR7jcwEdDloHvg"><div id="google_ads_iframe_/21711891156/jg_desktop_homecateg_sidebar_mid_0__container__" style={{ border: "0pt none" }}><iframe id="google_ads_iframe_/21711891156/jg_desktop_homecateg_sidebar_mid_0" title="3rd party ad content" name="google_ads_iframe_/21711891156/jg_desktop_homecateg_sidebar_mid_0" width="300" height="250" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" role="region" aria-label="Advertisement" tabindex="0" allow="attribution-reporting" srcdoc="" data-google-container-id="4" style={{ border: "0px, verticalAlign: bottom" }} data-load-complete="true"></iframe></div></div>
                  </div>

                </div>
                <div class="col">
                  <div class="epaper border border-bottom-0 text-center py-2">
                    <a href="https://epaper.jugantor.com/" target="_blank">
                      <img class="img-fluid" alt="Jugantor e-paper" src="https://www.jugantor.com/web-assets/img/e-paper.png" />
                    </a>
                  </div>
                  <div class="epaper_img border border-top-0" align="center">
                    <a href="https://epaper.jugantor.com" target="_blank">
                      <img class="w-100" src="https://epaper.jugantor.com/2022/01/02/1.jpg" alt="Jugantor e-paper" />
                    </a>
                  </div>
                </div>
                <div class="col d-none d-sm-none d-md-block d-lg-block d-xl-block">
                  ...
                  <div class="col-12 mb-3" align="center">
                    <div>
                      ...
                      <ins data-purplepatch-slotid="430" data-purplepatch-ct0="%%CLICK_URL_UNESC%%" data-purplepatch-id="53126d71827fcba70ff68055b9a73ca1" data-purplepatch-seq="0" id="purplepatch-0-0" data-purplepatch-loaded="1"><iframe scrolling="no" frameborder="0" width="300" height="250" style={{ border: "0px", overflow: "hidden" }}></iframe></ins>
                    </div>
                  </div>
                  <div class="spacebar"></div>
                </div>
                <div class="col d-lg-none d-xl-none mt-2">
                  <div class="spacebar"></div>
                  <div class="col-12 mb-3" align="center">
                    <div>

                      <ins data-purplepatch-slotid="639" data-purplepatch-ct0="%%CLICK_URL_UNESC%%" data-purplepatch-id="53126d71827fcba70ff68055b9a73ca1" data-purplepatch-seq="1" id="purplepatch-0-1" data-purplepatch-loaded="1"><iframe scrolling="no" frameborder="0" width="0" height="0" style={{ border: "0px", overflow: "hidden" }}></iframe></ins>
                    </div>
                  </div>
                  <div class="spacebar"></div>
                </div>
                <div class="col py-2">
                  <div class="facebook-responsive">
                    <div class="fb-page fb_iframe_widget" data-href="https://www.facebook.com/DainikJugantor" data-width="500px" data-hide-cover="false" data-show-facepile="true" fb-xfbml-state="rendered" fb-iframe-plugin-query="app_id=679179046220911&amp;container_width=360&amp;hide_cover=false&amp;href=https%3A%2F%2Fwww.facebook.com%2FDainikJugantor&amp;locale=en_US&amp;sdk=joey&amp;show_facepile=true&amp;width=500px"><span style={{ verticalAlign: "bottom", width: "360px", height: "130px" }}><iframe name="f3e456b262f71e8" height={1000} data-testid="fb:page Facebook Social Plugin" title="fb:page Facebook Social Plugin" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" src="https://www.facebook.com/v6.0/plugins/page.php?app_id=679179046220911&amp;channel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df1074a71f8de348%26domain%3Dwww.jugantor.com%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fwww.jugantor.com%252Ff3535fcaec0b39%26relation%3Dparent.parent&amp;container_width=360&amp;hide_cover=false&amp;href=https%3A%2F%2Fwww.facebook.com%2FDainikJugantor&amp;locale=en_US&amp;sdk=joey&amp;show_facepile=true&amp;width=500px" style={{ border: "none", visibility: "visible", width: "360px", height: "130px" }} class=""></iframe></span></div>
                  </div>
                </div>
                <div class="col pt-2 pt-sm-2 pt-md-0 pt-lg-3 pt-xl-3 d-block d-sm-block d-md-none">
                  <div align="center">
                    <div class="fb-group fb_iframe_widget" data-href="https://www.facebook.com/groups/dailyjugantor/" data-show-social-context="true" data-show-metadata="false" fb-xfbml-state="rendered" fb-iframe-plugin-query="app_id=679179046220911&amp;container_width=0&amp;href=https%3A%2F%2Fwww.facebook.com%2Fgroups%2Fdailyjugantor%2F&amp;locale=en_US&amp;sdk=joey&amp;show_metadata=false&amp;show_social_context=true"><span style={{ verticalAlign: "bottom", width: "280px", height: "0px" }}><iframe name="f34d0db6572afa8" width="1000px" height="1000px" data-testid="fb:group Facebook Social Plugin" title="fb:group Facebook Social Plugin" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" src="https://www.facebook.com/v6.0/plugins/group.php?app_id=679179046220911&amp;channel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df382ce4ac3a7f04%26domain%3Dwww.jugantor.com%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fwww.jugantor.com%252Ff3535fcaec0b39%26relation%3Dparent.parent&amp;container_width=0&amp;href=https%3A%2F%2Fwww.facebook.com%2Fgroups%2Fdailyjugantor%2F&amp;locale=en_US&amp;sdk=joey&amp;show_metadata=false&amp;show_social_context=true" class="" style={{ border: "none", visibility: "visible", width: "280px", height: "0px" }}></iframe></span></div>
                  </div>
                </div>

                <div class="col d-none d-sm-none d-md-block d-lg-block d-xl-block">
                  <div class="col-12 mb-3" align="center">
                    <div id="Jugantor_elc" class="pg-loaded" style={{ margin: "20px 0px 35px", textAlign: "center" }} data-google-query-id="CIi77fCvkvUCFcQDtwAdFo0IbQ"><div id="google_ads_iframe_/21711891156/Jugantor_elc_0__container__" style={{ border: "0pt none" }}><iframe id="google_ads_iframe_/21711891156/Jugantor_elc_0" title="3rd party ad content" name="google_ads_iframe_/21711891156/Jugantor_elc_0" width="300" height="250" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" role="region" aria-label="Advertisement" tabindex="0" allow="attribution-reporting" srcdoc="" data-google-container-id="7" style={{ border: "0px, verticalAlign: bottom" }} data-load-complete="true"></iframe></div></div>
                  </div>
                </div>

                <div id="online-poll" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-3 pt-xl-3">
                  <div class="right_poll_block">
                    <div class="right_poll_title"><a class="text-decoration-none" href="https://www.jugantor.com/online-poll/home/1431">অনলাইন জরিপ</a>
                    </div>
                    <div class="right_poll_cont">
                      <div class="poll_ques">সাবেক তত্ত্বাবধায়ক সরকারের উপদেষ্টা ড. আকবর আলি খান বলেছেন, সার্চ কমিটি করে লাভ নেই, ইসির তালিকা হয়ে গেছে।
                        আপনিও কি তা-ই মনে করেন?</div>
                      <div id="pollResSum">
                        <form action="https://www.jugantor.com/submit-online-poll" method="POST" enctype="multipart/form-data" role="form">
                          <input type="hidden" name="_token" id="poll_token" value="tB1MDeG4R8sKTYhZNEyS1mTdiH9yaS1gFFGXiTqy"/>
                            <div class="row">
                              <div class="col-3 col-sm-3 col-md-3 col-lg-3 opt">
                                <span>
                                  <input type="radio" id="option0" name="poll" value="হ্যাঁ"/>
                                    <label for="option0">হ্যাঁ</label>
                                </span>
                              </div>
                              <div class="col-3 col-sm-3 col-md-3 col-lg-3 opt">
                                <span>
                                  <input type="radio" id="option1" name="poll" value="না"/>
                                    <label for="option1">না</label>
                                </span>
                              </div>
                              <div class="col-6 col-sm-6 col-md-6 col-lg-6 opt">
                                <span>
                                  <input type="radio" id="option2" name="poll" value="মন্তব্য নেই"/>
                                    <label for="option2">মন্তব্য নেই</label>
                                </span>
                              </div>
                              <input type="hidden" value="1431" name="poll_id"/>
                                <input type="hidden" value="23.29.122.106" name="ip"/>
                                </div>
                              </form>
                            </div>
                            <div id="polling_result" class="pollingBox clearfix alink">
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tbody>
                                  <tr>
                                    <td class="pollSubmitTd" align="center" width="50%">
                                      <div class="pollSubmit btn btn-success">মতামত দিন</div>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
                              <a class="text-decoration-none" style={{fontSize:"16px", color:"#666", display:"inline-block", float:"right", marginTop:"10px"}} href="https://www.jugantor.com/online-poll">পুরনো ফলাফল <i class="fa fa-angle-right"></i></a>
                            </div>
                          </div>
                      </div>
                    </div>
                    <div id="biggapon" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-3 pt-xl-3">
                      <div class="right_new_block">
                        <div class="right_block_title"><a class="text-decoration-none" href="https://www.jugantor.com/ad-rate">বিজ্ঞাপন</a></div>
                        <div class="right_new_cont">
                          <ul class="px-1">
                            <li><a target="_blank" href="https://www.jugantor.com/ad-rate-print"><span><i class="fa fa-briefcase" aria-hidden="true"></i></span><b>প্রিন্ট সংস্করণ</b></a></li>
                            <li><a target="_blank" href="https://www.jugantor.com/ad-rate-online"><span><i class="fa fa-television" aria-hidden="true"></i></span><b>অনলাইন সংস্করণ</b></a></li>
                            <li><a target="_blank" href="https://www.jugantor.com/communication"><span><i class="fa fa-map-marker" aria-hidden="true"></i></span><b>যোগাযোগের ঠিকানা</b></a></li>
                          </ul>
                    ...
                    <div class="col d-none d-sm-none d-md-block d-lg-block d-xl-block">
                      <div class="col-12 mb-3" align="center">
                        <div class="spacebar"></div>
                        <div id="JG_DESKTOP_HOME1X1" class="pg-loaded" data-google-query-id="CPOfofOvkvUCFXnRcwEd5OQJfA" style={{ display: "none" }}>
                          <div id="google_ads_iframe_/21711891156/JG_DESKTOP_HOME1X1_0__container__" style={{ border: "0pt none" }}></div></div>
                      </div>
                    </div>


                    <div class="col col d-lg-none d-xl-none">
                      <div class="col-12 mb-3" align="center">
                        <div class="spacebar"></div>
                        <div id="JG_MOBILE_HOME1X1"></div>
                      </div>
                    </div>
                    ...
                    <div id="prayer-time" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-3 pt-xl-3">
                      <div class="prayerTimePanel">
                        <div class="prayerTimeTitle">
                          <img loading="lazy" class="img-fluid float-left mt-3 ml-4" width="35%" alt="Jugantor Logo" src="https://www.jugantor.com/web-assets/img/jugantor-logo.svg" />
                        </div>
                        <div class="dateShow">

                          {/* <script type="text/javascript">
                              var currentDate = new Date();
                              document.write(currentDate.toLocaleString("bn-BD",{day:"2-digit"}) + " " + currentDate.toLocaleString("bn-BD",{month:"long"}) + ", " + currentDate.toLocaleString("bn-BD",{year:"numeric"}));
                        ...
                        <div id="tablePrayTimes" class="prayerTimeTable">
                          <table cellspacing="1" cellpadding="1" width="100%">
                            <tbody>
                              <tr>
                                <td>
                                  <span class="prayerName">ফজর</span>
                                </td>
                                <td>
                                  <span class="prayerTime">৫:২১</span>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                  <span class="prayerName">জোহর</span>
                                </td>
                                <td>
                                  <span class="prayerTime">১২:০২</span>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                  <span class="prayerName">আসর</span>
                                </td>
                                <td>
                                  <span class="prayerTime">৪:২১</span>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                  <span class="prayerName">মাগরিব</span>
                                </td>
                                <td>
                                  <span class="prayerTime">৫:২৪</span>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                  <span class="prayerName">ইশা</span>
                                </td>
                                <td>
                                  <span class="prayerTime">৬:৩৯</span>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
                        <div id="tableSunTimes" class="nonPrayTime"><span class="sunrise">সূর্যাস্ত : ৫:২৪</span>
                          <span class="sunset">সূর্যোদয় : ৬:৪১</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col d-none d-sm-none d-md-block d-lg-block d-xl-block">
                      <div class="col-12 mb-3" align="center">
                        <div class="spacebar"></div>
                        <div id="jg_desktop_home_eskimi_300x250" class="pg-loaded" data-google-query-id="CPy4y-GxkvUCFTrMcwEdkSUCfQ" style={{ margin: "20px 0px 35px", display: "none", textAlign: "center" }}>
                          <div id="google_ads_iframe_/21711891156/jg_desktop_home_eskimi_300x250_0__container__" style={{ border: "0pt none", width: "300px", height: "0px" }}>
                          </div>
                  ...
                  <div class="home_menu_inner map_inner_block">
                    <div class="home_menu_online">জেলার খবর</div>
                  ...
                  <div class="map_inner">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="-201 -372.5 560 776.5" style="enable-background:new -201 -372.5 560 776.5;" xml:space="preserve">
                      ...
                      <g id="rangpur">
                        <a href="https://www.jugantor.com/country-news/rangpur" xlink:href="https://www.jugantor.com/country-news/rangpur">
                    ...
                    QmCC" transform="matrix(0.7972 0 0 0.7972 -116.5603 -268.4205)">
                      ...
                      <g id="sylhet">
                        <a href="https://www.jugantor.com/country-news/sylhet" xlink:href="https://www.jugantor.com/country-news/sylhet">
                    ...
                    xM63OXPU7+FbyjXxYbf5StyWUP9/fYdf/xBgAC9n6lG6sC1xAAAAAElFTkSuQmCC" transform="matrix(0.8485 0 0 0.8485 198.1667 -130.2727)">
                      ...
                      <g id="khulna">
                        <a href="https://www.jugantor.com/country-news/khulna" xlink:href="https://www.jugantor.com/country-news/khulna">
                    ...
                    oiMrnXhTGsZ3JpLOqicJ/j/eneNPAQYAqlIjWQakbmIAAAAASUVORK5CYII=" transform="matrix(0.9259 0 0 0.9259 -78.6667 95.6296)">
                      ...
                      <g id="dhaka">
                        <a href="https://www.jugantor.com/country-news/dhaka" xlink:href="https://www.jugantor.com/country-news/dhaka">
                    ...
                    AAAAADgafgowAC4wT/jUaBZlAAAAAElFTkSuQmCC" transform="matrix(1 0 0 1 38 -86)">
                      ...
                      <g id="mymensingh">
                        <a href="https://www.jugantor.com/country-news/mymensingh" xlink:href="https://www.jugantor.com/country-news/mymensingh">
                    ...
                    1fX6+q8AAwAexfCEjBB1ggAAAABJRU5ErkJggg==" transform="matrix(1.0957 0 0 1.0957 -3 -165.3478)">
                      ...
                      <g id="rajshahi">
                        <a href="https://www.jugantor.com/country-news/rajshahi" xlink:href="https://www.jugantor.com/country-news/rajshahi">
                    ...
                    zXvxONlKAAAAAElFTkSuQmCC" transform="matrix(0.8673 0 0 0.8673 -141.6667 -127)">
                      ...
                      <g id="borishal">
                        <a href="https://www.jugantor.com/country-news/barisal" xlink:href="https://www.jugantor.com/country-news/barisal">
                    ...
                    pNtZrT3uLWr4tnf+FmAA6KLD8jcePaIAAAAASUVORK5CYII=" transform="matrix(1.1322 0 0 1.1322 34.7654 163.216)">
                      ...
                      <g id="chittagong">
                        <a href="https://www.jugantor.com/country-news/chittagong" xlink:href="https://www.jugantor.com/country-news/chittagong">
                    ...
                    <form>
                      <div class="form-group row">
                        <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                          <select class="form-control" name="bd_division">
                            <option>-বিভাগ-</option>
                            <option value="1" data-val="dhaka">ঢাকা</option>
                            <option value="2" data-val="chittagong">চট্টগ্রাম</option>
                            <option value="3" data-val="rajshahi">রাজশাহী</option>
                            <option value="4" data-val="khulna">খুলনা</option>
                            <option value="5" data-val="barisal">বরিশাল</option>
                            <option value="6" data-val="sylhet">সিলেট</option>
                            <option value="7" data-val="rangpur">রংপুর</option>
                            <option value="8" data-val="mymensingh">ময়মনসিংহ</option>
                          </select>
                        </div>
                        <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                          <select name="bd_district" class="form-control">
                            <option value="">-জেলা-</option>
                            <option style="display:none" class="dist-1" data-val="dhaka" value="1">ঢাকা</option>
                            <option style="display:none" class="dist-1" data-val="faridpur" value="2">ফরিদপুর</option>
                            <option style="display:none" class="dist-1" data-val="gazipur" value="3">গাজীপুর</option>
                            <option style="display:none" class="dist-1" data-val="gopalganj" value="4">গোপালগঞ্জ</option>
                            <option style="display:none" class="dist-8" data-val="jamalpur" value="5">জামালপুর</option>
                            <option style="display:none" class="dist-1" data-val="kishoreganj" value="6">কিশোরগঞ্জ</option>
                            <option style="display:none" class="dist-1" data-val="madaripur" value="7">মাদারীপুর</option>
                            <option style="display:none" class="dist-1" data-val="manikganj" value="8">মানিকগঞ্জ</option>
                            <option style="display:none" class="dist-1" data-val="munshiganj" value="9">মুন্সীগঞ্জ</option>
                            <option style="display:none" class="dist-8" data-val="mymensingh" value="10">ময়মনসিংহ</option>
                            <option style="display:none" class="dist-1" data-val="narayanganj" value="11">নারায়ণগঞ্জ</option>
                            <option style="display:none" class="dist-1" data-val="narsingdi" value="12"> নরসিংদী</option>
                            <option style="display:none" class="dist-8" data-val="netrakona" value="13">নেত্রকোনা</option>
                            <option style="display:none" class="dist-1" data-val="rajbari" value="14">রাজবাড়ী</option>
                            <option style="display:none" class="dist-1" data-val="shariatpur" value="15">শরীয়তপুর</option>
                            <option style="display:none" class="dist-8" data-val="sherpur" value="16">শেরপুর</option>
                            <option style="display:none" class="dist-1" data-val="tangail" value="17">টাঙ্গাইল</option>
                            <option style="display:none" class="dist-2" data-val="bandarban" value="18">বান্দরবান</option>
                            <option style="display:none" class="dist-2" data-val="brahmanbaria" value="19">ব্রাহ্মণবাড়িয়া</option>
                            <option style="display:none" class="dist-2" data-val="chandpur" value="20">চাঁদপুর</option>
                            <option style="display:none" class="dist-2" data-val="chittagong" value="21">চট্টগ্রাম</option>
                            <option style="display:none" class="dist-2" data-val="comilla" value="22">কুমিল্লা</option>
                            <option style="display:none" class="dist-2" data-val="coxs-bazar" value="23">কক্সবাজার</option>
                            <option style="display:none" class="dist-2" data-val="feni" value="24">ফেনী</option>
                            <option style="display:none" class="dist-2" data-val="khagrachhari" value="25">খাগড়াছড়ি</option>
                            <option style="display:none" class="dist-2" data-val="lakshmipur" value="26">লক্ষীপুর</option>
                            <option style="display:none" class="dist-2" data-val="noakhali" value="27">নোয়াখালী</option>
                            <option style="display:none" class="dist-2" data-val="rangamati" value="28">রাঙ্গামাটি</option>
                            <option style="display:none" class="dist-3" data-val="bogra" value="29">বগুড়া</option>
                            <option style="display:none" class="dist-3" data-val="joypurhat" value="30">জয়পুরহাট</option>
                            <option style="display:none" class="dist-3" data-val="naogaon" value="31">নওগাঁ</option>
                            <option style="display:none" class="dist-3" data-val="natore" value="32">নাটোর</option>
                            <option style="display:none" class="dist-3" data-val="nawabganj" value="33">চাঁপাইনবাবগঞ্জ</option>
                            <option style="display:none" class="dist-3" data-val="pabna" value="34">পাবনা</option>
                            <option style="display:none" class="dist-3" data-val="rajshahi" value="35">রাজশাহী</option>
                            <option style="display:none" class="dist-3" data-val="sirajganj" value="36">সিরাজগঞ্জ</option>
                            <option style="display:none" class="dist-4" data-val="bagerhat" value="37">বাগেরহাট</option>
                            <option style="display:none" class="dist-4" data-val="chuadanga" value="38">চুয়াডাঙ্গা</option>
                            <option style="display:none" class="dist-4" data-val="jessore" value="39">যশোর</option>
                            <option style="display:none" class="dist-4" data-val="jhenaidah" value="40">ঝিনাইদহ</option>
                            <option style="display:none" class="dist-4" data-val="khulna" value="41">খুলনা</option>
                            <option style="display:none" class="dist-4" data-val="kushtia" value="42">কুষ্টিয়া</option>
                            <option style="display:none" class="dist-4" data-val="magura" value="43">মাগুরা</option>
                            <option style="display:none" class="dist-4" data-val="meherpur" value="44">মেহেরপুর</option>
                            <option style="display:none" class="dist-4" data-val="narail" value="45">নড়াইল</option>
                            <option style="display:none" class="dist-4" data-val="satkhira" value="46">সাতক্ষীরা</option>
                            <option style="display:none" class="dist-5" data-val="barguna" value="47">বরগুনা</option>
                            <option style="display:none" class="dist-5" data-val="barisal" value="48">বরিশাল</option>
                            <option style="display:none" class="dist-5" data-val="bhola" value="49">ভোলা</option>
                            <option style="display:none" class="dist-5" data-val="jhalokati" value="50">ঝালকাঠি</option>
                            <option style="display:none" class="dist-5" data-val="patuakhali" value="51">পটুয়াখালী</option>
                            <option style="display:none" class="dist-5" data-val="pirojpur" value="52">পিরোজপুর</option>
                            <option style="display:none" class="dist-6" data-val="habiganj" value="53">হবিগঞ্জ</option>
                            <option style="display:none" class="dist-6" data-val="maulvibazar" value="54">মৌলভীবাজার</option>
                            <option style="display:none" class="dist-6" data-val="sunamganj" value="55">সুনামগঞ্জ</option>
                            <option style="display:none" class="dist-6" data-val="sylhet" value="56">সিলেট</option>
                            <option style="display:none" class="dist-7" data-val="dinajpur" value="57">দিনাজপুর</option>
                            <option style="display:none" class="dist-7" data-val="gaibandha" value="58">গাইবান্ধা</option>
                            <option style="display:none" class="dist-7" data-val="kurigram" value="59">কুড়িগ্রাম</option>
                            <option style="display:none" class="dist-7" data-val="lalmonirhat" value="60">লালমনিরহাট</option>
                            <option style="display:none" class="dist-7" data-val="nilphamari" value="61">নীলফামারী</option>
                            <option style="display:none" class="dist-7" data-val="panchagarh" value="62">পঞ্চগড়</option>
                            <option style="display:none" class="dist-7" data-val="rangpur" value="63">রংপুর</option>
                            <option style="display:none" class="dist-7" data-val="thakurgaon" value="64">ঠাকুরগাঁও</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                          <select name="bd_thana" class="form-control">
                            <option value="">-উপজেলা-</option>
                            <option style="display:none" class="thana-1" value="savar">সাভার</option>
                            <option style="display:none" class="thana-1" value="dhamrai">ধামরাই</option>
                            <option style="display:none" class="thana-1" value="dohar">দোহার</option>
                            <option style="display:none" class="thana-1" value="keraniganj">কেরানীগঞ্জ</option>
                            <option style="display:none" class="thana-1" value="nawabganj">নবাবগঞ্জ</option>
                            <option style="display:none" class="thana-12" value="belabo">বেলাবো</option>
                            <option style="display:none" class="thana-12" value="monohardi">মনোহরদী</option>
                            <option style="display:none" class="thana-12" value="shibpur">শিবপুর</option>
                            <option style="display:none" class="thana-12" value="raipura">রায়পুরা</option>
                            <option style="display:none" class="thana-12" value="palash">পলাশ</option>
                            <option style="display:none" class="thana-12" value="narsingdi-sadar">নরসিংদী সদর</option>
                            <option style="display:none" class="thana-11" value="naryanganj-sadar">নারায়ানগঞ্জ সদর</option>
                            <option style="display:none" class="thana-11" value="bandar">বন্দর</option>
                            <option style="display:none" class="thana-11" value="araihazar">আড়াইহাজার</option>
                            <option style="display:none" class="thana-11" value="rupganj">রূপগঞ্জ</option>
                            <option style="display:none" class="thana-11" value="sonargaon">সোনারগাঁও</option>
                            <option style="display:none" class="thana-3" value="kaliakior">কালিয়াকৈর</option>
                            <option style="display:none" class="thana-3" value="kaliganj">কালীগঞ্জ</option>
                            <option style="display:none" class="thana-3" value="kapasia">কাপাসিয়া</option>
                            <option style="display:none" class="thana-3" value="gazipur-sadar">গাজীপুর সদর</option>
                            <option style="display:none" class="thana-3" value="sripur">শ্রীপুর</option>
                            <option style="display:none" class="thana-9" value="sreenagar">শ্রীনগর</option>
                            <option style="display:none" class="thana-9" value="sirajdikhan">সিরাজদীখান</option>
                            <option style="display:none" class="thana-9" value="lohajang">লৌহজং</option>
                            <option style="display:none" class="thana-9" value="tongibari">টঙ্গীবাড়ী</option>
                            <option style="display:none" class="thana-9" value="munshiganj-sadar">মুন্সিগঞ্জ সদর</option>
                            <option style="display:none" class="thana-9" value="gazaria">গজারিয়া</option>
                            <option style="display:none" class="thana-8" value="ghior">ঘিওর</option>
                            <option style="display:none" class="thana-8" value="daulatpur">দৌলতপুর</option>
                            <option style="display:none" class="thana-8" value="manikganj-sadar">মানিকগঞ্জ সদর</option>
                            <option style="display:none" class="thana-8" value="shibalaya">শিবালয়</option>
                            <option style="display:none" class="thana-8" value="saturia">সাটুরিয়া</option>
                            <option style="display:none" class="thana-8" value="singair">সিঙ্গাইর</option>
                            <option style="display:none" class="thana-8" value="harirampur">হরিরামপুর</option>
                            <option style="display:none" class="thana-17" value="tangail-sadar">টাঙ্গাইল সদর</option>
                            <option style="display:none" class="thana-17" value="kalihati">কালিহাতি</option>
                            <option style="display:none" class="thana-17" value="ghatail">ঘাটাইল</option>
                            <option style="display:none" class="thana-17" value="basail">বাসাইল</option>
                            <option style="display:none" class="thana-17" value="gopalpur">গোপালপুর</option>
                            <option style="display:none" class="thana-17" value="mirzapur">মির্জাপুর</option>
                            <option style="display:none" class="thana-17" value="bhuapur">ভূঞাপুর</option>
                            <option style="display:none" class="thana-17" value="nagarpur">নাগরপুর</option>
                            <option style="display:none" class="thana-17" value="madhupur">মধুপুর</option>
                            <option style="display:none" class="thana-17" value="sakhipur">সখিপুর</option>
                            <option style="display:none" class="thana-17" value="delduar">দেলদুয়ার</option>
                            <option style="display:none" class="thana-17" value="dhanbari">ধনবাড়ী</option>
                            <option style="display:none" class="thana-14" value="rajbari-sadar">রাজবাড়ি সদর</option>
                            <option style="display:none" class="thana-14" value="goalanda">গোয়ালন্দ</option>
                            <option style="display:none" class="thana-14" value="pangsha">পাংশা</option>
                            <option style="display:none" class="thana-14" value="baliakandi">বালিয়াকান্দি</option>
                            <option style="display:none" class="thana-14" value="kalukhali">কালুখালী</option>
                            <option style="display:none" class="thana-4" value="gopalganj-sadar">গোপালগঞ্জ সদর</option>
                            <option style="display:none" class="thana-4" value="muksudpur">মুকসুদপুর</option>
                            <option style="display:none" class="thana-4" value="kashiani">কাশিয়ানী</option>
                            <option style="display:none" class="thana-4" value="kotalipara">কোটালীপাড়া</option>
                            <option style="display:none" class="thana-4" value="tungipara">টুঙ্গিপাড়া</option>
                            <option style="display:none" class="thana-15" value="shariatpur-sadar">শরীয়তপুর সদর</option>
                            <option style="display:none" class="thana-15" value="damudya">ডামুড্যা</option>
                            <option style="display:none" class="thana-15" value="naria">নড়িয়া</option>
                            <option style="display:none" class="thana-15" value="bhedarganj">ভেদরগঞ্জ</option>
                            <option style="display:none" class="thana-15" value="jajira">জাজিরা</option>
                            <option style="display:none" class="thana-15" value="gosairhat">গোসাইরহাট</option>
                            <option style="display:none" class="thana-7" value="madaripur-sadar">মাদারীপুর সদর</option>
                            <option style="display:none" class="thana-7" value="shibchar">শিবচর</option>
                            <option style="display:none" class="thana-7" value="kalkini">কালকিনী</option>
                            <option style="display:none" class="thana-7" value="rajoir">রাজৈর</option>
                            <option style="display:none" class="thana-2" value="faridpur-sadar">ফরিদপুর সদর</option>
                            <option style="display:none" class="thana-2" value="boalmari">বোয়ালমারী</option>
                            <option style="display:none" class="thana-2" value="alfadanga">আলফাডাঙা</option>
                            <option style="display:none" class="thana-2" value="madhukhali">মধুখালী</option>
                            <option style="display:none" class="thana-2" value="bhanga">ভাঙ্গা</option>
                            <option style="display:none" class="thana-2" value="nagarkanda">নগরকান্দা</option>
                            <option style="display:none" class="thana-2" value="charbhadrasan">চর ভদ্রাসন</option>
                            <option style="display:none" class="thana-2" value="sadarpur">সদরপুর</option>
                            <option style="display:none" class="thana-2" value="shaltha">সালথা</option>
                            <option style="display:none" class="thana-6" value="kishoreganj-sadar">কিশোরগঞ্জ সদর</option>
                            <option style="display:none" class="thana-6" value="astagram">অষ্টগ্রাম</option>
                            <option style="display:none" class="thana-6" value="itna">ইটনা</option>
                            <option style="display:none" class="thana-6" value="karimganj">করিমগঞ্জ</option>
                            <option style="display:none" class="thana-6" value="katiadi">কটিয়াদী</option>
                            <option style="display:none" class="thana-6" value="kuliarchar">কুলিয়ারচর</option>
                            <option style="display:none" class="thana-6" value="tarail">তাড়াইল</option>
                            <option style="display:none" class="thana-6" value="nikli">নিকলী</option>
                            <option style="display:none" class="thana-6" value="pakundia">পাকুন্দিয়া</option>
                            <option style="display:none" class="thana-6" value="bajitpur">বাজিতপুর</option>
                            <option style="display:none" class="thana-6" value="bhairab">ভৈরব</option>
                            <option style="display:none" class="thana-6" value="mithamain">মিঠামইন</option>
                            <option style="display:none" class="thana-6" value="hossainpur">হোসেনপুর</option>
                            <option style="display:none" class="thana-54" value="barlekha">বড়লেখা</option>
                            <option style="display:none" class="thana-54" value="kulaura">কুলাউড়া</option>
                            <option style="display:none" class="thana-54" value="rajnagar">রাজনগর</option>
                            <option style="display:none" class="thana-54" value="kamalganj">কমলগঞ্জ</option>
                            <option style="display:none" class="thana-54" value="sreemangal">শ্রীমঙ্গল</option>
                            <option style="display:none" class="thana-54" value="moulvibazar-sadar">মৌলভীবাজার সদর</option>
                            <option style="display:none" class="thana-54" value="juri">জুড়ী</option>
                            <option style="display:none" class="thana-56" value="balaganj">বালাগঞ্জ</option>
                            <option style="display:none" class="thana-56" value="beanibazar">বিয়ানীবাজার</option>
                            <option style="display:none" class="thana-56" value="bishwanath">বিশ্বনাথ</option>
                            <option style="display:none" class="thana-56" value="companiganj">কোম্পানীগঞ্জ</option>
                            <option style="display:none" class="thana-56" value="fenchuganj">ফেঞ্চুগঞ্জ</option>
                            <option style="display:none" class="thana-56" value="golapganj">গোলাপগঞ্জ</option>
                            <option style="display:none" class="thana-56" value="gowainghat">গোয়াইনঘাট</option>
                            <option style="display:none" class="thana-56" value="jaintiapur">জৈন্তাপুর</option>
                            <option style="display:none" class="thana-56" value="kanaighat">কানাইঘাট</option>
                            <option style="display:none" class="thana-56" value="sylhet-sadar">সিলেট সদর</option>
                            <option style="display:none" class="thana-56" value="zakiganj">জকিগঞ্জ</option>
                            <option style="display:none" class="thana-56" value="south-surma">দক্ষিণ সুরমা</option>
                            <option style="display:none" class="thana-55" value="bishwamvarpur">বিশ্বম্ভরপুর</option>
                            <option style="display:none" class="thana-55" value="chhatak">ছাতক</option>
                            <option style="display:none" class="thana-55" value="derai">দিরাই</option>
                            <option style="display:none" class="thana-55" value="dharampasha">ধর্মপাশা</option>
                            <option style="display:none" class="thana-55" value="dowarabazar">দোয়ারাবাজার</option>
                            <option style="display:none" class="thana-55" value="jagannathpur">জগন্নাথপুর</option>
                            <option style="display:none" class="thana-55" value="jamalganj">জামালগঞ্জ</option>
                            <option style="display:none" class="thana-55" value="tahirpur">তাহিরপুর</option>
                            <option style="display:none" class="thana-55" value="sullah">শাল্লা</option>
                            <option style="display:none" class="thana-55" value="sunamganj-sadar">সুনামগঞ্জ সদর</option>
                            <option style="display:none" class="thana-53" value="ajmiriganj">আজমিরীগঞ্জ</option>
                            <option style="display:none" class="thana-53" value="chunarughat">চুনারুঘাট</option>
                            <option style="display:none" class="thana-53" value="nabiganj">নবীগঞ্জ</option>
                            <option style="display:none" class="thana-53" value="baniachang">বানিয়াচং</option>
                            <option style="display:none" class="thana-53" value="bahubal">বাহুবল</option>
                            <option style="display:none" class="thana-53" value="madhabpur">মাধবপুর</option>
                            <option style="display:none" class="thana-53" value="lakhai">লাখাই</option>
                            <option style="display:none" class="thana-53" value="habiganj-sadar">হবিগঞ্জ সদর</option>
                            <option style="display:none" class="thana-53" value="shaistagonj">শায়েস্তাগঞ্জ</option>
                            <option style="display:none" class="thana-35" value="bagha">বাঘা</option>
                            <option style="display:none" class="thana-35" value="puthia">পুঠিয়া</option>
                            <option style="display:none" class="thana-35" value="paba">পবা</option>
                            <option style="display:none" class="thana-35" value="bagmara">বাগমারা</option>
                            <option style="display:none" class="thana-35" value="tanore">তানোর</option>
                            <option style="display:none" class="thana-35" value="mohanpur">মোহনপুর</option>
                            <option style="display:none" class="thana-35" value="charghat">চারঘাট</option>
                            <option style="display:none" class="thana-35" value="godagari">গোদাগাড়ী</option>
                            <option style="display:none" class="thana-35" value="durgapur">দূর্গাপুর</option>
                            <option style="display:none" class="thana-32" value="natore-sadar">নাটোর সদর</option>
                            <option style="display:none" class="thana-32" value="bagatipara">বাগাতিপাড়া</option>
                            <option style="display:none" class="thana-32" value="baraigram">বরাইগ্রাম</option>
                            <option style="display:none" class="thana-32" value="gurudaspur">গুরুদাসপুর</option>
                            <option style="display:none" class="thana-32" value="lalpur">লালপুর</option>
                            <option style="display:none" class="thana-32" value="singra">সিংড়া</option>
                            <option style="display:none" class="thana-32" value="naldanga">নলডাঙ্গা</option>
                            <option style="display:none" class="thana-33" value="capainawabganj-sadar">চাঁপাইনবাবগঞ্জ সদর</option>
                            <option style="display:none" class="thana-33" value="gomastapur">গোমস্তাপুর</option>
                            <option style="display:none" class="thana-33" value="shibganj">শিবগঞ্জ</option>
                            <option style="display:none" class="thana-33" value="nachole">নাচোল</option>
                            <option style="display:none" class="thana-33" value="bholahat">ভোলাহাট</option>
                            <option style="display:none" class="thana-30" value="panchbibi">পাঁচবিবি</option>
                            <option style="display:none" class="thana-30" value="joypurhat-sadar">জয়পুরহাট সদর</option>
                            <option style="display:none" class="thana-30" value="kalai">কালাই</option>
                            <option style="display:none" class="thana-30" value="khetlal">ক্ষেতলাল</option>
                            <option style="display:none" class="thana-30" value="akkelpur">আক্কেলপুর</option>
                            <option style="display:none" class="thana-31" value="patnitala">পত্নীতলা</option>
                            <option style="display:none" class="thana-31" value="dhamorhat">ধামুরহাট</option>
                            <option style="display:none" class="thana-31" value="mohadevpur">মহাদেবপুর</option>
                            <option style="display:none" class="thana-31" value="porsha">পরশা</option>
                            <option style="display:none" class="thana-31" value="sapahar">সাপাহার</option>
                            <option style="display:none" class="thana-31" value="badalgachhi">বদলগাছী</option>
                            <option style="display:none" class="thana-31" value="manda">মান্দা</option>
                            <option style="display:none" class="thana-31" value="niamatpur">নিয়ামতপুর</option>
                            <option style="display:none" class="thana-31" value="atrai">আত্রাই</option>
                            <option style="display:none" class="thana-31" value="raninagar">রানীনগর</option>
                            <option style="display:none" class="thana-31" value="naogaon-sadar">নওগাঁ সদর</option>
                            <option style="display:none" class="thana-29" value="adamdighi">আদমদিঘী</option>
                            <option style="display:none" class="thana-29" value="bogra-sadar">বগুড়া সদর</option>
                            <option style="display:none" class="thana-29" value="dhunat">ধুনট</option>
                            <option style="display:none" class="thana-29" value="dhupchanchia">ধুপচাঁচিয়া</option>
                            <option style="display:none" class="thana-29" value="gabtali">গাবতলী</option>
                            <option style="display:none" class="thana-29" value="kahaloo">কাহালু</option>
                            <option style="display:none" class="thana-29" value="nandigram">নন্দীগ্রাম</option>
                            <option style="display:none" class="thana-29" value="sariakandi">সারিয়াকান্দি</option>
                            <option style="display:none" class="thana-29" value="sherpur">শেরপুর</option>
                            <option style="display:none" class="thana-29" value="shibganj">শিবগঞ্জ</option>
                            <option style="display:none" class="thana-29" value="sonatala">সোনাতলা</option>
                            <option style="display:none" class="thana-29" value="sahajanpur">শাজাহানপুর</option>
                            <option style="display:none" class="thana-34" value="atgharia">আটঘরিয়া</option>
                            <option style="display:none" class="thana-34" value="ishwardi">ঈশ্বরদী</option>
                            <option style="display:none" class="thana-34" value="chatmohar">চাটমোহর</option>
                            <option style="display:none" class="thana-34" value="pabna-sadar">পাবনা সদর</option>
                            <option style="display:none" class="thana-34" value="faridpur">ফরিদপুর</option>
                            <option style="display:none" class="thana-34" value="bera">বেড়া</option>
                            <option style="display:none" class="thana-34" value="bhangura">ভাঙ্গুরা</option>
                            <option style="display:none" class="thana-34" value="sujanagar">সুজানগর</option>
                            <option style="display:none" class="thana-34" value="sathia">সাঁথিয়া</option>
                            <option style="display:none" class="thana-36" value="ullahpara">উল্লাপাড়া</option>
                            <option style="display:none" class="thana-36" value="kamarkhanda">কামারখন্দ</option>
                            <option style="display:none" class="thana-36" value="kazipur">কাজীপুর</option>
                            <option style="display:none" class="thana-36" value="chauhali">চৌহালি</option>
                            <option style="display:none" class="thana-36" value="tarash">তাড়াশ</option>
                            <option style="display:none" class="thana-36" value="belkuchi">বেলকুচি</option>
                            <option style="display:none" class="thana-36" value="raiganj">রায়গঞ্জ</option>
                            <option style="display:none" class="thana-36" value="shahjadpur">শাহজাদপুর</option>
                            <option style="display:none" class="thana-36" value="sirajganj-sadar">সিরাজগঞ্জ সদর</option>
                            <option style="display:none" class="thana-63" value="rangpur-sadar">রংপুর সদর</option>
                            <option style="display:none" class="thana-63" value="badarganj">বদরগঞ্জ</option>
                            <option style="display:none" class="thana-63" value="gangachara">গংগাচড়া</option>
                            <option style="display:none" class="thana-63" value="kaunia">কাউনিয়া</option>
                            <option style="display:none" class="thana-63" value="mithapukur">মিঠাপুকুর</option>
                            <option style="display:none" class="thana-63" value="pirgachha">পীরগাছা</option>
                            <option style="display:none" class="thana-63" value="pirganj">পীরগঞ্জ</option>
                            <option style="display:none" class="thana-63" value="taraganj">তারাগঞ্জ</option>
                            <option style="display:none" class="thana-57" value="birampur">বিরামপুর</option>
                            <option style="display:none" class="thana-57" value="birganj">বীরগঞ্জ</option>
                            <option style="display:none" class="thana-57" value="bochaganj">বোচাগঞ্জ</option>
                            <option style="display:none" class="thana-57" value="fulbari">ফুলবাড়ী</option>
                            <option style="display:none" class="thana-57" value="chirirbandar">চিরিরবন্দর</option>
                            <option style="display:none" class="thana-57" value="ghoraghat">ঘোড়াঘাট</option>
                            <option style="display:none" class="thana-57" value="hakimpur">হাকিমপুর</option>
                            <option style="display:none" class="thana-57" value="kaharole">কাহারোল</option>
                            <option style="display:none" class="thana-57" value="khansama">খানসামা</option>
                            <option style="display:none" class="thana-57" value="dinajpur-sadar">দিনাজপুর সদর</option>
                            <option style="display:none" class="thana-57" value="nawabganj">নবাবগঞ্জ</option>
                            <option style="display:none" class="thana-57" value="parbatipur">পার্বতীপুর</option>
                            <option style="display:none" class="thana-57" value="biral">বিরল</option>
                            <option style="display:none" class="thana-58" value="gaibandha-sadar">গাইবান্ধা সদর</option>
                            <option style="display:none" class="thana-58" value="fulchhari">ফুলছড়ি</option>
                            <option style="display:none" class="thana-58" value="gobindaganj">গোবিন্দগঞ্জ</option>
                            <option style="display:none" class="thana-58" value="palashbari">পলাশবাড়ী</option>
                            <option style="display:none" class="thana-58" value="sadullapur">সাদুল্লাপুর</option>
                            <option style="display:none" class="thana-58" value="saghata">সাঘাটা</option>
                            <option style="display:none" class="thana-58" value="sundarganj">সুন্দরগঞ্জ</option>
                            <option style="display:none" class="thana-59" value="ulipur">উলিপুর</option>
                            <option style="display:none" class="thana-59" value="kurigram-sadar">কুড়িগ্রাম সদর</option>
                            <option style="display:none" class="thana-59" value="char-rajibpur">চর রাজিবপুর</option>
                            <option style="display:none" class="thana-59" value="chilmari">চিলমারী</option>
                            <option style="display:none" class="thana-59" value="nageshwari">নাগেশ্বরী</option>
                            <option style="display:none" class="thana-59" value="fulbari">ফুলবাড়ী</option>
                            <option style="display:none" class="thana-59" value="bhurungamari">ভুরুঙ্গামারী</option>
                            <option style="display:none" class="thana-59" value="rajarhat">রাজারহাট</option>
                            <option style="display:none" class="thana-59" value="rowmari">রৌমারী</option>
                            <option style="display:none" class="thana-61" value="nilphamari-sadar">নিলফামারী সদর</option>
                            <option style="display:none" class="thana-61" value="domar">ডোমার</option>
                            <option style="display:none" class="thana-61" value="dimla">ডিমলা</option>
                            <option style="display:none" class="thana-61" value="jaldhaka">জলঢাকা</option>
                            <option style="display:none" class="thana-61" value="kishoreganj">কিশোরগঞ্জ</option>
                            <option style="display:none" class="thana-61" value="saidpur">সৈয়দপুর</option>
                            <option style="display:none" class="thana-62" value="debiganj">দেবীগঞ্জ</option>
                            <option style="display:none" class="thana-62" value="tetulia">তেতুলিয়া</option>
                            <option style="display:none" class="thana-62" value="panchagarh-sadar">পঞ্চগড় সদর</option>
                            <option style="display:none" class="thana-62" value="atwari">আটোয়ারী</option>
                            <option style="display:none" class="thana-62" value="boda">বোদা</option>
                            <option style="display:none" class="thana-64" value="thakurgaon-sadar">ঠাকুরগাঁও সদর</option>
                            <option style="display:none" class="thana-64" value="pirganj">পীরগঞ্জ</option>
                            <option style="display:none" class="thana-64" value="baliadangi">বালিয়াডাঙ্গী</option>
                            <option style="display:none" class="thana-64" value="ranisankail">রানীশংকৈল</option>
                            <option style="display:none" class="thana-64" value="haripur">হরিপুর</option>
                            <option style="display:none" class="thana-60" value="aditmari">আদিতমারী</option>
                            <option style="display:none" class="thana-60" value="kaliganj">কালীগঞ্জ</option>
                            <option style="display:none" class="thana-60" value="patgram">পাটগ্রাম</option>
                            <option style="display:none" class="thana-60" value="lalmanirhat-sadar">লালমনিরহাট সদর</option>
                            <option style="display:none" class="thana-60" value="hatibandha">হাতীবান্ধা</option>
                            <option style="display:none" class="thana-10" value="mymensingh-sadar">ময়মনসিংহ সদর</option>
                            <option style="display:none" class="thana-10" value="trishal">ত্রিশাল</option>
                            <option style="display:none" class="thana-10" value="gauripur">গৌরীপুর</option>
                            <option style="display:none" class="thana-10" value="muktagachha">মুক্তাগাছা</option>
                            <option style="display:none" class="thana-10" value="phulpur">ফুলপুর</option>
                            <option style="display:none" class="thana-10" value="tarakanda">তারাকান্দা</option>
                            <option style="display:none" class="thana-10" value="haluaghat">হালুয়াঘাট</option>
                            <option style="display:none" class="thana-10" value="bhaluka">ভালুকা</option>
                            <option style="display:none" class="thana-10" value="fulbaria">ফুলবাড়িয়া</option>
                            <option style="display:none" class="thana-10" value="gaffargaon">গফরগাঁও</option>
                            <option style="display:none" class="thana-10" value="ishwarganj">ঈশ্বরগঞ্জ</option>
                            <option style="display:none" class="thana-10" value="nandail">নান্দাইল</option>
                            <option style="display:none" class="thana-10" value="dhobaura">ধোবাউড়া</option>
                            <option style="display:none" class="thana-16" value="jhenaigati">ঝিনাইগাতী</option>
                            <option style="display:none" class="thana-16" value="nakla">নকলা</option>
                            <option style="display:none" class="thana-16" value="nalitabari">নালিতাবাড়ী</option>
                            <option style="display:none" class="thana-16" value="sherpur-sadar">শেরপুর সদর</option>
                            <option style="display:none" class="thana-16" value="sreebardi">শ্রীবরদী</option>
                            <option style="display:none" class="thana-5" value="jamalpur-sadar">জামালপুর সদর</option>
                            <option style="display:none" class="thana-5" value="baksiganj">বকশীগঞ্জ</option>
                            <option style="display:none" class="thana-5" value="dewanganj">দেওয়ানগঞ্জ</option>
                            <option style="display:none" class="thana-5" value="islampur">ইসলামপুর</option>
                            <option style="display:none" class="thana-5" value="madarganj">মাদারগঞ্জ</option>
                            <option style="display:none" class="thana-5" value="melandaha">মেলান্দহ</option>
                            <option style="display:none" class="thana-5" value="sarishabari">সরিষাবাড়ি</option>
                            <option style="display:none" class="thana-13" value="atpara">আটপাড়া</option>
                            <option style="display:none" class="thana-13" value="barhatta">বারহাট্টা</option>
                            <option style="display:none" class="thana-13" value="durgapur">দুর্গাপুর</option>
                            <option style="display:none" class="thana-13" value="khaliajuri">খালিয়াজুড়ি</option>
                            <option style="display:none" class="thana-13" value="kalmakanda">কলমাকান্দা</option>
                            <option style="display:none" class="thana-13" value="kendua">কেন্দুয়া</option>
                            <option style="display:none" class="thana-13" value="madan">মদন</option>
                            <option style="display:none" class="thana-13" value="mohanganj">মোহনগঞ্জ</option>
                            <option style="display:none" class="thana-13" value="netrakona-sadar">নেত্রকোনা সদর</option>
                            <option style="display:none" class="thana-13" value="purbadhala">পূর্বধলা</option>
                            <option style="display:none" class="thana-48" value="agailjhara">আগৈলঝাড়া</option>
                            <option style="display:none" class="thana-48" value="bakerganj">বাকেরগঞ্জ</option>
                            <option style="display:none" class="thana-48" value="babuganj">বাবুগঞ্জ</option>
                            <option style="display:none" class="thana-48" value="banaripara">বানারীপাড়া</option>
                            <option style="display:none" class="thana-48" value="gaurnadi">গৌরনদী</option>
                            <option style="display:none" class="thana-48" value="hizla">হিজলা</option>
                            <option style="display:none" class="thana-48" value="barisal-sadar">বরিশাল সদর</option>
                            <option style="display:none" class="thana-48" value="mehendiganj">মেহেন্দিগঞ্জ</option>
                            <option style="display:none" class="thana-48" value="muladi">মুলাদী</option>
                            <option style="display:none" class="thana-48" value="wazirpur">উজিরপুর</option>
                            <option style="display:none" class="thana-47" value="barguna-sadar">বরগুনা সদর</option>
                            <option style="display:none" class="thana-47" value="amtali">আমতলী</option>
                            <option style="display:none" class="thana-47" value="taltali">তালতলী</option>
                            <option style="display:none" class="thana-47" value="patharghata">পাথরঘাটা</option>
                            <option style="display:none" class="thana-47" value="betagi">বেতাগি</option>
                            <option style="display:none" class="thana-47" value="bamna">বামনা</option>
                            <option style="display:none" class="thana-49" value="char-fasson">চরফ্যাশন</option>
                            <option style="display:none" class="thana-49" value="tazumuddin">তজমুদ্দিন</option>
                            <option style="display:none" class="thana-49" value="daulatkhan">দৌলতখান</option>
                            <option style="display:none" class="thana-49" value="burhanuddin">বোরহানউদ্দিন</option>
                            <option style="display:none" class="thana-49" value="bhola-sadar">ভোলা সদর</option>
                            <option style="display:none" class="thana-49" value="manpura">মনপুরা</option>
                            <option style="display:none" class="thana-49" value="lalmohan">লালমোহন</option>
                            <option style="display:none" class="thana-50" value="kathalia">কাঁঠালিয়া</option>
                            <option style="display:none" class="thana-50" value="jhalokati-sadar">ঝালকাঠি সদর</option>
                            <option style="display:none" class="thana-50" value="nalchity">নলছিটি</option>
                            <option style="display:none" class="thana-50" value="rajapur">রাজাপুর</option>
                            <option style="display:none" class="thana-51" value="patuakhali-sadar">পটুয়াখালী সদর</option>
                            <option style="display:none" class="thana-51" value="bauphal">বাউফল</option>
                            <option style="display:none" class="thana-51" value="dashmina">দশমিনা</option>
                            <option style="display:none" class="thana-51" value="galachipa">গলাচিপা</option>
                            <option style="display:none" class="thana-51" value="kalapara">কলাপাড়া</option>
                            <option style="display:none" class="thana-51" value="mirzaganj">মির্জাগঞ্জ</option>
                            <option style="display:none" class="thana-51" value="dumki">দুমকি</option>
                            <option style="display:none" class="thana-51" value="rangabali">রাঙ্গাবালী</option>
                            <option style="display:none" class="thana-52" value="kaukhali">কাউখালী</option>
                            <option style="display:none" class="thana-52" value="nazirpur">নাজিরপুর</option>
                            <option style="display:none" class="thana-52" value="nesarabad">নেছারাবাদ (স্বরূপকাঠি)</option>
                            <option style="display:none" class="thana-52" value="pirojpur-sadar">পিরোজপুর সদর</option>
                            <option style="display:none" class="thana-52" value="bhandaria">ভাণ্ডারিয়া</option>
                            <option style="display:none" class="thana-52" value="mathbaria">মঠবাড়িয়া</option>
                            <option style="display:none" class="thana-47" value="zianagar">ইন্দুরকানী</option>
                            <option style="display:none" class="thana-42" value="kumarkhali">কুমারখালী</option>
                            <option style="display:none" class="thana-42" value="kushtia-sadar">কুষ্টিয়া সদর</option>
                            <option style="display:none" class="thana-42" value="khoksa">খোকসা</option>
                            <option style="display:none" class="thana-42" value="daulatpur">দৌলতপুর</option>
                            <option style="display:none" class="thana-42" value="bheramara">ভেড়ামারা</option>
                            <option style="display:none" class="thana-42" value="mirpur">মিরপুর</option>
                            <option style="display:none" class="thana-41" value="koyra">কয়রা</option>
                            <option style="display:none" class="thana-41" value="dumuria">ডুমুরিয়া</option>
                            <option style="display:none" class="thana-41" value="terokhada">তেরখাদা</option>
                            <option style="display:none" class="thana-41" value="dacope">দাকোপ</option>
                            <option style="display:none" class="thana-41" value="dighalia">দিঘলিয়া</option>
                            <option style="display:none" class="thana-41" value="paikgachha">পাইকগাছা</option>
                            <option style="display:none" class="thana-41" value="phultala">ফুলতলা</option>
                            <option style="display:none" class="thana-41" value="batiaghata">বাটিয়াঘাটা</option>
                            <option style="display:none" class="thana-41" value="rupsa">রূপসা</option>
                            <option style="display:none" class="thana-38" value="alamdanga">আলমডাঙ্গা</option>
                            <option style="display:none" class="thana-38" value="chuadanga-sadar">চুয়াডাঙ্গা সদর</option>
                            <option style="display:none" class="thana-38" value="jibannagar">জীবননগর</option>
                            <option style="display:none" class="thana-38" value="damurhuda">দামুড়হুদা</option>
                            <option style="display:none" class="thana-40" value="kaliganj">কালীগঞ্জ</option>
                            <option style="display:none" class="thana-40" value="kotchandpur">কোটচাঁদপুর</option>
                            <option style="display:none" class="thana-40" value="jhenaidah-sadar">ঝিনাইদহ সদর</option>
                            <option style="display:none" class="thana-40" value="maheshpur">মহেশপুর</option>
                            <option style="display:none" class="thana-40" value="shailkupa">শৈলকুপা</option>
                            <option style="display:none" class="thana-40" value="harinakunda">হরিণাকুন্ডু</option>
                            <option style="display:none" class="thana-45" value="kalia">কালিয়া</option>
                            <option style="display:none" class="thana-45" value="narail-sadar">নড়াইল সদর</option>
                            <option style="display:none" class="thana-45" value="lohagara">লোহাগড়া</option>
                            <option style="display:none" class="thana-37" value="kachua">কচুয়া</option>
                            <option style="display:none" class="thana-37" value="chitalmari">চিতলমারী</option>
                            <option style="display:none" class="thana-37" value="fakirhat">ফকিরহাট</option>
                            <option style="display:none" class="thana-37" value="bagerhat-sadar">বাগেরহাট সদর</option>
                            <option style="display:none" class="thana-37" value="mongla">মোংলা</option>
                            <option style="display:none" class="thana-37" value="morrelganj">মোড়েলগঞ্জ</option>
                            <option style="display:none" class="thana-37" value="mollahat">মোল্লাহাট</option>
                            <option style="display:none" class="thana-37" value="rampal">রামপাল</option>
                            <option style="display:none" class="thana-37" value="sarankhola">শরণখোলা</option>
                            <option style="display:none" class="thana-43" value="magura-sadar">মাগুরা সদর</option>
                            <option style="display:none" class="thana-43" value="mohammadpur">মোহাম্মদপুর</option>
                            <option style="display:none" class="thana-43" value="shalikha">শালিখা</option>
                            <option style="display:none" class="thana-43" value="sreepur">শ্রীপুর</option>
                            <option style="display:none" class="thana-44" value="gangni">গাংনী</option>
                            <option style="display:none" class="thana-44" value="meherpur-sadar">মেহেরপুর সদর</option>
                            <option style="display:none" class="thana-44" value="mujibnagar">মুজিবনগর</option>
                            <option style="display:none" class="thana-39" value="abhaynagar">অভয়নগর</option>
                            <option style="display:none" class="thana-39" value="keshabpur">কেশবপুর</option>
                            <option style="display:none" class="thana-39" value="chaugachha">চৌগাছা</option>
                            <option style="display:none" class="thana-39" value="jhikargachha">ঝিকরগাছা</option>
                            <option style="display:none" class="thana-39" value="bagherpara">বাঘারপাড়া</option>
                            <option style="display:none" class="thana-39" value="manirampur">মনিরামপুর</option>
                            <option style="display:none" class="thana-39" value="jessore-sadar">যশোর সদর</option>
                            <option style="display:none" class="thana-39" value="sarsha">শার্শা</option>
                            <option style="display:none" class="thana-46" value="assasuni">আশাশুনি</option>
                            <option style="display:none" class="thana-46" value="kalaroa">কলারোয়া</option>
                            <option style="display:none" class="thana-46" value="kaliganj">কালীগঞ্জ</option>
                            <option style="display:none" class="thana-46" value="tala">তালা</option>
                            <option style="display:none" class="thana-46" value="debhata">দেবহাটা</option>
                            <option style="display:none" class="thana-46" value="shyamnagar">শ্যামনগর</option>
                            <option style="display:none" class="thana-46" value="satkhira-sadar">সাতক্ষীরা সদর</option>
                            <option style="display:none" class="thana-21" value="anwara">আনোয়ারা</option>
                            <option style="display:none" class="thana-21" value="bashkhali">বাঁশখালী</option>
                            <option style="display:none" class="thana-21" value="boalkhali">বোয়ালখালী</option>
                            <option style="display:none" class="thana-21" value="chandanaish">চন্দনাঈশ</option>
                            <option style="display:none" class="thana-21" value="fatikchhari">ফটিকছড়ি</option>
                            <option style="display:none" class="thana-18" value="hathazari">হাটহাজারী</option>
                            <option style="display:none" class="thana-21" value="lohagara">লোহাগাড়া</option>
                            <option style="display:none" class="thana-21" value="mirsharai">মীরসরাই</option>
                            <option style="display:none" class="thana-21" value="patiya">পটিয়া</option>
                            <option style="display:none" class="thana-21" value="rangunia">রাঙ্গুনিয়া</option>
                            <option style="display:none" class="thana-21" value="raozan">রাউজান</option>
                            <option style="display:none" class="thana-21" value="sandwip">সন্দ্বীপ</option>
                            <option style="display:none" class="thana-21" value="satkania">সাতকানিয়া</option>
                            <option style="display:none" class="thana-21" value="sitakunda">সীতাকুণ্ড</option>
                            <option style="display:none" class="thana-21" value="kornofuli">কর্ণফুলী</option>
                            <option style="display:none" class="thana-23" value="ukhia">উখিয়া</option>
                            <option style="display:none" class="thana-23" value="cox'sbazar-sadar">কক্সবাজার সদর</option>
                            <option style="display:none" class="thana-23" value="kutubdia">কুতুবদিয়া</option>
                            <option style="display:none" class="thana-23" value="chakaria">চকোরিয়া</option>
                            <option style="display:none" class="thana-23" value="teknaf">টেকনাফ</option>
                            <option style="display:none" class="thana-23" value="maheshkhali">মহেশখালী</option>
                            <option style="display:none" class="thana-23" value="ramu">রামু</option>
                            <option style="display:none" class="thana-23" value="pekua">পেকুয়া</option>
                            <option style="display:none" class="thana-18" value="alikodom">আলিকদম</option>
                            <option style="display:none" class="thana-18" value="thanchi">থানচি</option>
                            <option style="display:none" class="thana-18" value="naikhongchhari">নাইক্ষ্যংছড়ি</option>
                            <option style="display:none" class="thana-18" value="bandarban-sadar">বান্দরবন সদর</option>
                            <option style="display:none" class="thana-18" value="ruma">রুমা</option>
                            <option style="display:none" class="thana-18" value="rowangchhari">রোয়াংছড়ি</option>
                            <option style="display:none" class="thana-18" value="lama">লামা</option>
                            <option style="display:none" class="thana-25" value="khagrachhari-sadar">খাগড়াছড়ি সদর</option>
                            <option style="display:none" class="thana-25" value="dighinala">দীঘিনালা</option>
                            <option style="display:none" class="thana-25" value="panchhari">পানছড়ি</option>
                            <option style="display:none" class="thana-25" value="mahalchhari">মহালছড়ি</option>
                            <option style="display:none" class="thana-25" value="matiranga">মাটিরাঙ্গা</option>
                            <option style="display:none" class="thana-25" value="manikchhari">মানিকছড়ি</option>
                            <option style="display:none" class="thana-25" value="ramgarh">রামগড়</option>
                            <option style="display:none" class="thana-25" value="lakshmichhari">লক্ষীছড়ি</option>
                            <option style="display:none" class="thana-28" value="kaukhali">কাউখালী</option>
                            <option style="display:none" class="thana-28" value="kaptai">কাপ্তাই</option>
                            <option style="display:none" class="thana-28" value="juraichhari">জুরাছড়ি</option>
                            <option style="display:none" class="thana-28" value="naniachor">নানিয়াচর</option>
                            <option style="display:none" class="thana-28" value="barkal">বরকল</option>
                            <option style="display:none" class="thana-28" value="bagaichhari">বাঘাইছড়ি</option>
                            <option style="display:none" class="thana-28" value="belaichhari">বিলাইছড়ি</option>
                            <option style="display:none" class="thana-28" value="rangamati-sadar">রাঙ্গামাটি সদর</option>
                            <option style="display:none" class="thana-28" value="rajasthali">রাজস্থলী</option>
                            <option style="display:none" class="thana-28" value="langadu">লংগদু</option>
                            <option style="display:none" class="thana-28" value="guimara">গুইমারা</option>
                            <option style="display:none" class="thana-27" value="noakhali-sadar">নোয়াখালী সদর</option>
                            <option style="display:none" class="thana-27" value="begumganj">বেগমগঞ্জ</option>
                            <option style="display:none" class="thana-27" value="chatkhil">চাটখিল</option>
                            <option style="display:none" class="thana-27" value="companyganj">কোম্পানীগঞ্জ</option>
                            <option style="display:none" class="thana-27" value="hatia">হাতিয়া</option>
                            <option style="display:none" class="thana-27" value="shenbag">সেনবাগ</option>
                            <option style="display:none" class="thana-27" value="suborno-char">সুবর্ণ চর</option>
                            <option style="display:none" class="thana-27" value="sonaimuri">সোনাইমুড়ি</option>
                            <option style="display:none" class="thana-27" value="kobirhat">কবিরহাট</option>
                            <option style="display:none" class="thana-26" value="lakshmipur-sadar">লক্ষ্মীপুর সদর</option>
                            <option style="display:none" class="thana-26" value="raipur">রায়পুর</option>
                            <option style="display:none" class="thana-26" value="ramganj">রামগঞ্জ</option>
                            <option style="display:none" class="thana-26" value="komolnagar">কমলনগর</option>
                            <option style="display:none" class="thana-26" value="ramgati">রামগতি</option>
                            <option style="display:none" class="thana-24" value="feni-sadar">ফেনী সদর</option>
                            <option style="display:none" class="thana-24" value="daganbhyan">দাগনভূঁইয়া</option>
                            <option style="display:none" class="thana-24" value="sonagazi">সোনাগাজী</option>
                            <option style="display:none" class="thana-24" value="chagalnaiya">ছাগলনাইয়া</option>
                            <option style="display:none" class="thana-24" value="parshuram">পরশুরাম</option>
                            <option style="display:none" class="thana-24" value="fhulgazi">ফুলগাজী</option>
                            <option style="display:none" class="thana-22" value="barura">বরুরা</option>
                            <option style="display:none" class="thana-22" value="chandina">চান্দিনা</option>
                            <option style="display:none" class="thana-22" value="daudkandi">দাউদকান্দি</option>
                            <option style="display:none" class="thana-22" value="laksam">লাকসাম</option>
                            <option style="display:none" class="thana-22" value="brahmanpara">ব্রাহ্মণপাড়া</option>
                            <option style="display:none" class="thana-22" value="burichong">বুড়িচং</option>
                            <option style="display:none" class="thana-22" value="chauddagram">চৌদ্দগ্রাম</option>
                            <option style="display:none" class="thana-22" value="debidwar">দেবীদ্বার</option>
                            <option style="display:none" class="thana-22" value="homna">হোমনা</option>
                            <option style="display:none" class="thana-22" value="muradnagar">মুরাদনগর</option>
                            <option style="display:none" class="thana-22" value="nangalkot">লাঙ্গলকোট</option>
                            <option style="display:none" class="thana-22" value="meghna">মেঘনা</option>
                            <option style="display:none" class="thana-22" value="titas">তিতাস</option>
                            <option style="display:none" class="thana-22" value="monohorgonj">মনোহরগঞ্জ</option>
                            <option style="display:none" class="thana-22" value="comilla-sadar">কুমিল্লা সদর</option>
                            <option style="display:none" class="thana-22" value="sadar-south">সদর দক্ষিণ</option>
                            <option style="display:none" class="thana-22" value="lalmai">লালমাই</option>
                            <option style="display:none" class="thana-20" value="chandpur-sadar">চাঁদপুর সদর</option>
                            <option style="display:none" class="thana-20" value="haziganj">হাজীগঞ্জ</option>
                            <option style="display:none" class="thana-20" value="kachua">কচুয়া</option>
                            <option style="display:none" class="thana-20" value="faridganj">ফরিদগঞ্জ</option>
                            <option style="display:none" class="thana-20" value="matlab-north">মতলব উত্তর</option>
                            <option style="display:none" class="thana-20" value="matlab-south">মতলব দক্ষিণ</option>
                            <option style="display:none" class="thana-20" value="haimchar">হাইমচর</option>
                            <option style="display:none" class="thana-20" value="shahrasti">শাহরাস্তি</option>
                            <option style="display:none" class="thana-19" value="ashuganj">আশুগঞ্জ</option>
                            <option style="display:none" class="thana-19" value="akhaura">আখাউড়া</option>
                            <option style="display:none" class="thana-19" value="kasba">কসবা</option>
                            <option style="display:none" class="thana-19" value="nabinagar">নবীনগর</option>
                            <option style="display:none" class="thana-19" value="nasirnagar">নাসিরনগর</option>
                            <option style="display:none" class="thana-19" value="bancharampur">বাঞ্ছারামপুর</option>
                            <option style="display:none" class="thana-19" value="brahmanbaria-sadar">ব্রাহ্মণবাড়িয়া সদর</option>
                            <option style="display:none" class="thana-19" value="sarail">সরাইল</option>
                            <option style="display:none" class="thana-19" value="bijoynagar">বিজয়নগর</option>
                            <option style="display:none" class="thana-21" value="hathazari">হাটহাজারী</option>
                            <option style="display:none" class="thana-55" value="south-sunamganj">দক্ষিণ সুনামগঞ্জ</option>
                            <option style="display:none" class="thana-56" value="osmaninagor">ওসমানী নগর</option>
                            <option style="display:none" class="thana-52" value="indurkani">ইন্দুরকানী</option>
                          </select>
                        </div>
                        <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <div class="col d-none d-sm-none d-md-block d-lg-block d-xl-block pt-2 pt-sm-2 pt-md-0 pt-lg-3 pt-xl-3">
                      <a href="https://www.eximbankbd.com/" target="_blank">
                        <img loading="lazy" src="https://www.jugantor.com/web-assets/img/exim_bank.png" class="img-fluid w-100" alt="exim bank" />
                      </a>
                    </div>
                    <div class="col d-none d-sm-none d-md-block d-lg-block d-xl-block pt-2 pt-sm-2 pt-md-0 pt-lg-3 pt-xl-3">
                      <a href="https://jamunagroup.com.bd/" target="_blank">
                        <img loading="lazy" src="https://www.jugantor.com/web-assets/img/SSP_mils.gif" class="img-fluid w-100" alt="SSP mils" />
                      </a>
                    </div>
                    <div class="col d-none d-sm-none d-md-block d-lg-block d-xl-block pt-2 pt-sm-2 pt-md-0 pt-lg-3 pt-xl-3">
                      <a href="https://jamunagroup.com.bd/" target="_blank">
                        <img loading="lazy" src="https://www.jugantor.com/web-assets/img/jamuna.gif" class="img-fluid w-100" alt="jamuna" />
                      </a>
                    </div>
                    <div id="ad-default" class="col d-none d-sm-none d-md-block d-lg-block d-xl-block pt-2 pt-sm-2 pt-md-0 pt-lg-3 pt-xl-3">
                      <a href="https://jamunagroup.com.bd/" target="_blank">
                        <img loading="lazy" src="https://www.jugantor.com/web-assets/img/dada.gif" class="img-fluid w-100" alt="jamuna" />
                      </a>
                    </div>
                    <div id="archive" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-3 pt-xl-3 mb-2">
                      <div class="right_new_block">
                        <div class="right_block_title"><a class="text-decoration-none" href="https://www.jugantor.com/archive">আর্কাইভ</a>
                        </div>
                        <div class="right_new_cont" align="center">
                          <div id="archive_calendar" class="calendarWraper pr-xl-2 w-md-auto w-lg-100" style={{ width: "345px" }}>
                            <div class="calendarTop">
                              <div class="editionType">
                                <span class="print_edition active" data-val="">প্রিন্ট সংস্করণ</span>
                                <span data-val="online-edition">অনলাইন সংস্করণ</span>
                              </div>
                              <div class="datePicker">
                                <select class="select monthSelector"><option value="1">জানুয়ারি</option></select>
                                <select class="select yearSelector"><option value="2017">২০১৭</option><option value="2018">২০১৮</option><option value="2019">২০১৯</option><option value="2020">২০২০</option><option value="2021">২০২১</option><option value="2022">২০২২</option></select>
                              </div>
                            </div>
                            <dl class="dayZone">
                              <dt style={{ width: "48px", height: "45px", lineheight: "45px" }}>শনি</dt>
                              <dt style={{ width: "48px", height: "45px", lineheight: "45px" }}>রোব</dt>
                              <dt style={{ width: "48px", height: "45px", lineheight: "45px" }}>সোম</dt>
                              <dt style={{ width: "48px", height: "45px", lineheight: "45px" }}>মঙ্গল</dt>
                              <dt style={{ width: "48px", height: "45px", lineheight: "45px" }}>বুধ</dt>
                              <dt style={{ width: "48px", height: "45px", lineheight: "45px" }}>বৃহ</dt>
                              <dt style={{ width: "48px", height: "45px", lineheight: "45px" }}>শুক্র</dt>
                              <dd class="dn" style={{ width: "48px", height: "45px", lineheight: "45px" }}></dd>
                            </dl>
                            <dl class="dateZone dayHolder">
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="https://www.jugantor.com/archive/2022/01/01" class="" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>০১</a></dd><dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="https://www.jugantor.com/archive/2022/01/02" class="active" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>০২</a></dd><dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>০৩</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>০৪</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>০৫</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>০৬</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>০৭</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>০৮</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>০৯</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>১০</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>১১</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>১২</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>১৩</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>১৪</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>১৫</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>১৬</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>১৭</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>১৮</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>১৯</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>২০</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>২১</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>২২</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>২৩</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>২৪</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>২৫</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>২৬</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>২৭</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>২৮</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>২৯</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>৩০</a>
                              </dd>
                              <dd style={{ width: "48px", height: "45px", lineheight: "45px" }}>
                                <a href="javascript:" class="disabled" style={{ width: "45px", height: "46px", lineHeight: "45px" }}>৩১</a>
                              </dd>
                            </dl>
                          </div>
                        </div>
